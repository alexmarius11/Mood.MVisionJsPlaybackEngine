...
define(["require", "exports", "../../../../../app/ts/reusable/rm_coreservices/re_playlist/RE_PlaylistItem_Video"], function (require, exports, rmCoreServicesPlaylistItemVideo) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var rm_coreservices;
    (function (rm_coreservices) {
        var RE_PlaylistItem_ScreenSaverVideo = /** @class */ (function (_super) {
            __extends(RE_PlaylistItem_ScreenSaverVideo, _super);
            //----------------
            function RE_PlaylistItem_ScreenSaverVideo() {
                var _this = _super.call(this) || this;
                _this._playlistItemTypeName = "SCREEN_SAVER_VIDEO";
                //------------------ metadata
                ...
                _this._prop_Keep_Aspect_Ratio = null;
                _this._prop_Sound_Volume = null;
                _this._prop_True_Duration = null;
            ...
            //------------------------------
            RE_PlaylistItem_ScreenSaverVideo.prototype.loadProperties = function (playlistType, jsonObject, aPlaylistFile, aParent, error, context, callback) {
            ...
            //------------------------------
            RE_PlaylistItem_ScreenSaverVideo.prototype.loadProperties_MoodV5 = function (playlistType, jsonObject, aPlaylistFile, aParent, error, context, callback) {
            };
            //------------------------------
            RE_PlaylistItem_ScreenSaverVideo.prototype.loadProperties_CustomV1 = function (playlistType, jsonObject, aPlaylistFile, aParent, error, context, callback) {
            };
            //-----------------------------------------------------
            RE_PlaylistItem_ScreenSaverVideo.prototype.toJSONString = function () {
                var result = "{";
                ...
                result += "," + "Properties : " +
                    ...
                    "Keep_Aspect_Ratio : " + JSON.stringify(this._prop_Keep_Aspect_Ratio) + "," +
                    "Sound_Volume : " + JSON.stringify(this._prop_Sound_Volume) + "," +
                    "True_Duration : " + JSON.stringify(this._prop_True_Duration) + "," +
            ...
            return RE_PlaylistItem_ScreenSaverVideo;
        }(rmCoreServicesPlaylistItemVideo.rm_coreservices.RE_PlaylistItem_Video));
        rm_coreservices.RE_PlaylistItem_ScreenSaverVideo = RE_PlaylistItem_ScreenSaverVideo;
    })(rm_coreservices = exports.rm_coreservices || (exports.rm_coreservices = {}));
});
//# sourceMappingURL=RE_PlaylistItem_ScreenSaverVideo.js.map