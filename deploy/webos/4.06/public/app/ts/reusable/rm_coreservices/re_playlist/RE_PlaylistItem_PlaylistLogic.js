...
define(["require", "exports", "../../../../../app/ts/abstract/am_coreservices/ae_playlist/AE_PlaylistItemStatusType", "../../../../../app/ts/abstract/am_coreservices/ae_playlist/AE_NextChildSelectionType", "../../../../../app/ts/reusable/rm_coreservices/re_playlist/RE_PlaylistItem_ContainerLogic"], function (require, exports, amPlaylistItemStatusType, amNextChildSelectionType, rmPlaylistItemContainerLogic) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    //==========================================================
    var rm_coreservices;
    (function (rm_coreservices) {
        var RE_PlaylistItem_PlaylistLogic = /** @class */ (function (_super) {
            __extends(RE_PlaylistItem_PlaylistLogic, _super);
            //----------------
            function RE_PlaylistItem_PlaylistLogic() {
                var _this = _super.call(this) || this;
                _this._hasARenderingRepresentation = false;
                _this._hasARenderingZone = false;
                _this._nextChildSelectionType = amNextChildSelectionType.am_coreservices.AE_NextChildSelectionType.NextChildSelectionType_OneAfterTheOther_NoLoop_WithDiffusion;
            ...
            //==============
            RE_PlaylistItem_PlaylistLogic.prototype.reset = function () {
            ...
            //------------------------------
            RE_PlaylistItem_PlaylistLogic.prototype.injectDependencies = function (aSrvContainer, aSrvLocator, aSrvLog, error) {
            ...
            //======================
            RE_PlaylistItem_PlaylistLogic.prototype.receiveEvent = function (event, eventQueue, error, aPlaylistController, aRenderingController, context, callback) {
                switch (this._status) {
            ...
            return RE_PlaylistItem_PlaylistLogic;
        }(rmPlaylistItemContainerLogic.rm_coreservices.RE_PlaylistItem_ContainerLogic));
        rm_coreservices.RE_PlaylistItem_PlaylistLogic = RE_PlaylistItem_PlaylistLogic;
    })(rm_coreservices = exports.rm_coreservices || (exports.rm_coreservices = {}));
});
//# sourceMappingURL=RE_PlaylistItem_PlaylistLogic.js.map