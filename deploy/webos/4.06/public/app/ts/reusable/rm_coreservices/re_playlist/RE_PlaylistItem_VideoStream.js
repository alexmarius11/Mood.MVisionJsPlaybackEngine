...
define(["require", "exports", "../../../../../app/ts/reusable/rm_coreservices/re_playlist/RE_PlaylistItem_MediaItem"], function (require, exports, rmCoreServicesPlaylistItem) {
    ...
    (function (rm_coreservices) {
        var RE_PlaylistItem_VideoStream = /** @class */ (function (_super) {
            __extends(RE_PlaylistItem_VideoStream, _super);
            //----------------
            function RE_PlaylistItem_VideoStream() {
                var _this = _super.call(this) || this;
                _this._playlistItemTypeName = "VIDEO_STREAM";
                //------------------ metadata
            ...
            //------------------------------
            RE_PlaylistItem_VideoStream.prototype.loadProperties = function (playlistType, jsonObject, aPlaylistFile, aParent, error, context, callback) {
            ...
            //------------------------------
            RE_PlaylistItem_VideoStream.prototype.loadProperties_MoodV5 = function (playlistType, jsonObject, aPlaylistFile, aParent, error, context, callback) {
            };
            //------------------------------
            RE_PlaylistItem_VideoStream.prototype.loadProperties_CustomV1 = function (playlistType, jsonObject, aPlaylistFile, aParent, error, context, callback) {
            };
            //-----------------------------------------------------
            RE_PlaylistItem_VideoStream.prototype.toJSONString = function () {
                var result = "{";
                ...
                result += "," + "Properties : " +
                    ...
                    "Url : " + JSON.stringify(this._prop_Url) + "," +
                    "Type : " + JSON.stringify(this._prop_StreamType) +
                    "}";
            ...
            return RE_PlaylistItem_VideoStream;
        }(rmCoreServicesPlaylistItem.rm_coreservices.RE_PlaylistItem_MediaItem));
        rm_coreservices.RE_PlaylistItem_VideoStream = RE_PlaylistItem_VideoStream;
    })(rm_coreservices = exports.rm_coreservices || (exports.rm_coreservices = {}));
});
//# sourceMappingURL=RE_PlaylistItem_VideoStream.js.map