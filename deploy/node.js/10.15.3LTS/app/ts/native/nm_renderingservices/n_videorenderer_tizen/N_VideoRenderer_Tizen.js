...
var nmRenderingServices2 = require("../../../../../app/ts/native/nm_renderingservices/n_videorenderer_tizen/IImpl_VideoRenderer_Tizen");
...
(function (nm_renderingservices) {
    var N_VideoRenderer_Tizen = (function (_super) {
        ...
        function N_VideoRenderer_Tizen(aFactoryDescription, aServiceContainer, aLogService, error) {
            ...
            _this._iVideoRenderer = new nmRenderingServices2.nm_renderingservices.IImpl_VideoRenderer_Tizen(_this);
