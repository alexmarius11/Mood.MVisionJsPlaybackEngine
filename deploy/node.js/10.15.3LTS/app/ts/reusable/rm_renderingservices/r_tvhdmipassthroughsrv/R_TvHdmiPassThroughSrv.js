...
var rmRenderingServices2 = require("../../../../../app/ts/reusable/rm_renderingservices/r_tvhdmipassthroughsrv/IImpl_TvHdmiPassThroughSrv_R");
...
(function (rm_renderingservices) {
    var R_TvHdmiPassThroughSrv = (function (_super) {
        ...
        function R_TvHdmiPassThroughSrv(aFactoryDescription, aServiceContainer, aLogService, error) {
            ...
            _this._iTvHdmiPassThroughSrv = new rmRenderingServices2.rm_renderingservices.IImpl_TvHdmiPassThroughSrv_R(_this);
