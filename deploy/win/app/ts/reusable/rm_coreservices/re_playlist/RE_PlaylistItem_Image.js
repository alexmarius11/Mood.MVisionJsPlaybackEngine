...
(function (rm_coreservices) {
    var RE_PlaylistItem_Image = (function (_super) {
        __extends(RE_PlaylistItem_Image, _super);
        function RE_PlaylistItem_Image() {
            var _this = _super.call(this) || this;
            _this._playlistItemTypeName = "IMAGE";
        ...
        RE_PlaylistItem_Image.prototype.loadProperties = function (playlistType, jsonObject, aPlaylistFile, aParent, error, context, callback) {
        ...
        RE_PlaylistItem_Image.prototype.loadProperties_MoodV5 = function (playlistType, jsonObject, aPlaylistFile, aParent, error, context, callback) {
        };
        RE_PlaylistItem_Image.prototype.loadProperties_CustomV1 = function (playlistType, jsonObject, aPlaylistFile, aParent, error, context, callback) {
        };
        RE_PlaylistItem_Image.prototype.toJSONString = function () {
            var result = "{";
        ...
        return RE_PlaylistItem_Image;
    }(rmCoreServicesPlaylistItem.rm_coreservices.RE_PlaylistItem_MediaItem));
    rm_coreservices.RE_PlaylistItem_Image = RE_PlaylistItem_Image;
})(rm_coreservices = exports.rm_coreservices || (exports.rm_coreservices = {}));
//# sourceMappingURL=RE_PlaylistItem_Image.js.map