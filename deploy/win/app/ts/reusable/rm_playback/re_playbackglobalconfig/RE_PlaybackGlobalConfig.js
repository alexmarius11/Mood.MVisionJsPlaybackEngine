...
(function (rm_playback) {
    var RE_PlaybackGlobalConfig = (function (_super) {
        ...
        RE_PlaybackGlobalConfig.prototype.initFolders = function (defaultAppStorageName, defaultAppStorageUrlName, defaultResourceStorageName, defaultResourceStorageUrlName, defaultStorageUrlName, defaultStorageSameDomainUrlName, appName, appVersion, error) {
            this._aAppRootFolder.setStorage(defaultAppStorageName);
            ...
            this._aHardwareSettingsXmlFile.setUrlStorage(defaultResourceStorageUrlName);
            ...
            this._aOpeningHoursXmlFile.setStorage(defaultResourceStorageName);
            ...
            this._aOpeningHoursXmlFile.setUrlStorage(defaultResourceStorageUrlName);
