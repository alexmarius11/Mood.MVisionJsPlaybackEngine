...
define(["require", "exports", "./bigint.asm", "../other/utils", "../other/errors", "./extgcd", "../other/get-random-values"], function (require, exports, bigint_asm_1, utils_1, errors_1, extgcd_1, get_random_values_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ///////////////////////////////////////////////////////////////////////////////
    exports._bigint_stdlib = { Uint32Array: Uint32Array, Math: Math };
    exports._bigint_heap = new Uint32Array(0x100000);
    function _half_imul(a, b) {
        return (a * b) | 0;
    }
    if (exports._bigint_stdlib.Math.imul === undefined) {
        exports._bigint_stdlib.Math.imul = _half_imul;
        exports._bigint_asm = bigint_asm_1.bigint_asm(exports._bigint_stdlib, null, exports._bigint_heap.buffer);
        delete exports._bigint_stdlib.Math.imul;
    }
    else {
        exports._bigint_asm = bigint_asm_1.bigint_asm(exports._bigint_stdlib, null, exports._bigint_heap.buffer);
    }
    ...
    var BigNumber = /** @class */ (function () {
        ...
        BigNumber.fromString = function (str) {
            var bytes = utils_1.string_to_bytes(str);
        ...
        BigNumber.prototype.toString = function (radix) {
            ...
            if (radix === 16) {
                ...
                throw new errors_1.IllegalArgumentError('bad radix');
            }
            if (this.sign < 0)
                str = '-' + str;
            return str;
        ...
        BigNumber.prototype.compare = function (that) {
            ...
            if (this.sign > that.sign)
                return 1;
            exports._bigint_heap.set(alimbs, 0);
            exports._bigint_heap.set(blimbs, alimbcnt);
            z = exports._bigint_asm.cmp(0, alimbcnt << 2, alimbcnt << 2, blimbcnt << 2);
            return z * this.sign;
        };
        BigNumber.prototype.add = function (that) {
            ...
            exports._bigint_asm.sreset();
            var pA = exports._bigint_asm.salloc(alimbcnt << 2), pB = exports._bigint_asm.salloc(blimbcnt << 2), pR = exports._bigint_asm.salloc(rlimbcnt << 2);
            exports._bigint_asm.z(pR - pA + (rlimbcnt << 2), 0, pA);
            exports._bigint_heap.set(alimbs, pA >> 2);
            exports._bigint_heap.set(blimbs, pB >> 2);
            if (asign * bsign > 0) {
                exports._bigint_asm.add(pA, alimbcnt << 2, pB, blimbcnt << 2, pR, rlimbcnt << 2);
                rsign = asign;
            }
            else if (asign > bsign) {
                rof = exports._bigint_asm.sub(pA, alimbcnt << 2, pB, blimbcnt << 2, pR, rlimbcnt << 2);
                rsign = rof ? bsign : asign;
            }
            else {
                rof = exports._bigint_asm.sub(pB, blimbcnt << 2, pA, alimbcnt << 2, pR, rlimbcnt << 2);
                rsign = rof ? asign : bsign;
            }
            if (rof)
                exports._bigint_asm.neg(pR, rlimbcnt << 2, pR, rlimbcnt << 2);
            if (exports._bigint_asm.tst(pR, rlimbcnt << 2) === 0)
                return BigNumber.ZERO;
            result.limbs = new Uint32Array(exports._bigint_heap.subarray(pR >> 2, (pR >> 2) + rlimbcnt));
        ...
        BigNumber.prototype.square = function () {
            ...
            rlimbcnt = (rbitlen + 31) >> 5;
            exports._bigint_asm.sreset();
            var pA = exports._bigint_asm.salloc(alimbcnt << 2), pR = exports._bigint_asm.salloc(rlimbcnt << 2);
            exports._bigint_asm.z(pR - pA + (rlimbcnt << 2), 0, pA);
            exports._bigint_heap.set(alimbs, pA >> 2);
            exports._bigint_asm.sqr(pA, alimbcnt << 2, pR);
            result.limbs = new Uint32Array(exports._bigint_heap.subarray(pR >> 2, (pR >> 2) + rlimbcnt));
            result.bitLength = rbitlen;
            result.sign = 1;
            return result;
        ...
        BigNumber.prototype.divide = function (that) {
            ...
            exports._bigint_asm.sreset();
            var pA = exports._bigint_asm.salloc(alimbcnt << 2), pB = exports._bigint_asm.salloc(blimbcnt << 2), pQ = exports._bigint_asm.salloc(alimbcnt << 2);
            exports._bigint_asm.z(pQ - pA + (alimbcnt << 2), 0, pA);
            exports._bigint_heap.set(alimbs, pA >> 2);
            exports._bigint_heap.set(blimbs, pB >> 2);
            exports._bigint_asm.div(pA, alimbcnt << 2, pB, blimbcnt << 2, pQ);
            qlimbcnt = exports._bigint_asm.tst(pQ, alimbcnt << 2) >> 2;
            if (qlimbcnt) {
                quotient = new BigNumber();
                quotient.limbs = new Uint32Array(exports._bigint_heap.subarray(pQ >> 2, (pQ >> 2) + qlimbcnt));
                quotient.bitLength = abitlen < qlimbcnt << 5 ? abitlen : qlimbcnt << 5;
                quotient.sign = this.sign * that.sign;
            }
            rlimbcnt = exports._bigint_asm.tst(pA, blimbcnt << 2) >> 2;
            if (rlimbcnt) {
                remainder = new BigNumber();
                remainder.limbs = new Uint32Array(exports._bigint_heap.subarray(pA >> 2, (pA >> 2) + rlimbcnt));
        ...
        BigNumber.prototype.multiply = function (that) {
            ...
            exports._bigint_heap.set(alimbs, pA >> 2);
            exports._bigint_heap.set(blimbs, pB >> 2);
            exports._bigint_asm.mul(pA, alimbcnt << 2, pB, blimbcnt << 2, pR, rlimbcnt << 2);
            result.limbs = new Uint32Array(exports._bigint_heap.subarray(pR >> 2, (pR >> 2) + rlimbcnt));
        ...
        BigNumber.prototype.isMillerRabinProbablePrime = function (rounds) {
            ...
            while (a.limbs[l] === 0)
                l--;
            while (--rounds >= 0) {
                get_random_values_1.getRandomValues(a.limbs);
                if (a.limbs[0] < 2)
                    a.limbs[0] += 2;
        ...
        BigNumber.extGCD = extgcd_1.BigNumber_extGCD;
    ...
    var Modulus = /** @class */ (function (_super) {
        ...
        function Modulus(number) {
            ...
            if (_this.limbs[0] & 1) {
                ...
                var k = extgcd_1.Number_extGCD(0x100000000, _this.limbs[0]).y;
        ...
        Modulus.prototype.inverse = function (a) {
            a = this.reduce(a);
            var r = extgcd_1.BigNumber_extGCD(this, a);
            if (r.gcd.valueOf() !== 1)
        ...
        Modulus._Montgomery_reduce = function (a, n) {
            ...
            var y = n.coefficient;
            exports._bigint_asm.sreset();
            var pA = exports._bigint_asm.salloc(alimbcnt << 2), pN = exports._bigint_asm.salloc(nlimbcnt << 2), pR = exports._bigint_asm.salloc(nlimbcnt << 2);
            exports._bigint_asm.z(pR - pA + (nlimbcnt << 2), 0, pA);
            exports._bigint_heap.set(alimbs, pA >> 2);
            exports._bigint_heap.set(nlimbs, pN >> 2);
            exports._bigint_asm.mredc(pA, alimbcnt << 2, pN, nlimbcnt << 2, y, pR);
            var result = new BigNumber();
            result.limbs = new Uint32Array(exports._bigint_heap.subarray(pR >> 2, (pR >> 2) + nlimbcnt));
