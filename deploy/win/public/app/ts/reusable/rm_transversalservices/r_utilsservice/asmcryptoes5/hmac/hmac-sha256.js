...
define(["require", "exports", "./hmac", "../other/errors", "../hash/sha256/sha256"], function (require, exports, hmac_1, errors_1, sha256_1) {
    "use strict";
    ...
    var HmacSha256 = /** @class */ (function (_super) {
        ...
        HmacSha256.prototype.finish = function () {
            ...
            var result = new Uint8Array(sha256_1._sha256_hash_size);
            result.set(heap.subarray(0, sha256_1._sha256_hash_size));
            if (verify) {
