define(["require", "exports", "../other/errors"], function (require, exports, errors_1) {
    "use strict";
    ...
    var Hmac = /** @class */ (function () {
        ...
        Hmac.prototype._hmac_init_verify = function (verify) {
            if (verify.length !== this.HMAC_SIZE)
                throw new errors_1.IllegalArgumentError('illegal verification tag size');
            this.verify = verify;
        };
        return Hmac;
    }());
