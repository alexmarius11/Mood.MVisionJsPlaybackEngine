...
(function () {
            ...
            getHeading: function (onSuccess, onFailure) {
                ...
                if (window.device.name !== "TouchPad" && window.device.name !== "Pre3" && onFailure) {
                    ...
                    var onReadingChanged = function (e) {
                        ...
                        var diff = Math.min(Math.abs(e.trueHeading - e.magHeading), Math.abs((e.trueHeading + 360) - e.magHeading), Math.abs(e.trueHeading - (e.magHeading + 360)));
    ...
    define("cordova/plugin/webos/filereader", function (require, exports, module) {
        var FileError = require('cordova/plugin/FileError'), ProgressEvent = require('cordova/plugin/ProgressEvent');
        var FileReader = function () {
            this.fileName = "";
                ...
                child.executeScript = function (injectDetails, callback) {
                    if (injectDetails.code) {
                        ...
                        if (child.document.readyState === "interactive" || child.document.readyState === "complete" ||
                            ...
                            /* jshint evil: true */
                            child.document.write('<scri' + 'pt src="' + injectDetails.file + '"' +
                ...
                child.insertCSS = function (injectDetails, callback) {
                    ...
                    if (injectDetails.code) {
                        if (ready) {
                            ...
                            /* jshint evil: true */
                            child.document.write('<style media="screen" type="text/css" >' +
                        ...
                        if (ready) {
                            ...
                            /* jshint evil: true */
                            child.document.write('<link href="' + inPath + '" media="screen" rel="' +
            ...
            if (!navigator.connectionMonitor.request) {
                navigator.connectionMonitor.request = service.request('luna://com.palm.connectionmanager', {
                    ...
                    onSuccess: function (result) {
                        ...
                        if (result.wan && result.wan.state === "connected") {
                            type = Connection.CELL;
                        }
                        if (result.wifi && result.wifi.onInternet) {
                            type = Connection.WIFI;
                        }
                        if (result.wired && result.wired.onInternet) {
...
//# sourceMappingURL=cordova.webos.js.map