...
define(["require", "exports", "../../../../../app/ts/reusable/rm_coreservices/re_playlist/RE_PlaylistItem_Container"], function (require, exports, rmCoreServicesPlaylistItemContainer) {
    ...
    (function (rm_coreservices) {
        var RE_PlaylistItem_Tag = /** @class */ (function (_super) {
            __extends(RE_PlaylistItem_Tag, _super);
            //----------------
            function RE_PlaylistItem_Tag() {
                var _this = _super.call(this) || this;
                _this._playlistItemTypeName = "TAG";
            ...
            //------------------------------
            RE_PlaylistItem_Tag.prototype.loadProperties = function (playlistType, jsonObject, aPlaylistFile, aParent, error, context, callback) {
            ...
            //------------------------------
            RE_PlaylistItem_Tag.prototype.loadProperties_MoodV5 = function (playlistType, jsonObject, aPlaylistFile, aParent, error, context, callback) {
            };
            //------------------------------
            RE_PlaylistItem_Tag.prototype.loadProperties_CustomV1 = function (playlistType, jsonObject, aPlaylistFile, aParent, error, context, callback) {
            };
            //-----------------------------------------------------
            RE_PlaylistItem_Tag.prototype.toJSONString = function () {
                var result = "{";
            ...
            return RE_PlaylistItem_Tag;
        }(rmCoreServicesPlaylistItemContainer.rm_coreservices.RE_PlaylistItem_Container));
        rm_coreservices.RE_PlaylistItem_Tag = RE_PlaylistItem_Tag;
    })(rm_coreservices = exports.rm_coreservices || (exports.rm_coreservices = {}));
});
//# sourceMappingURL=RE_PlaylistItem_Tag.js.map