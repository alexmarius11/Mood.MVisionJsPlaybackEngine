...
define(["require", "exports", "../../../../../app/ts/abstract/am_coreservices/ae_playlist/AE_PlaylistItemStatusType", "../../../../../app/ts/abstract/am_coreservices/ae_playlist/AE_PlaylistItemEventType", "../../../../../app/ts/reusable/rm_coreservices/re_playliststatus/RE_PlaylistItem_Status"], function (require, exports, amPlaylistItemStatusType, amPlaylistItemEventType, rmPlaylistItemStatus) {
    ...
    (function (rm_coreservices) {
        var RE_PlaylistItem_StatusEnd = /** @class */ (function (_super) {
            ...
            RE_PlaylistItem_StatusEnd.prototype.createRenderingZoneIfNecessary = function (event, eventQueue, error, aPlaylistController, aRenderingController, context, callback) {
                ...
                if (this.getDiagram().mustCreateARenderingZone()) {
                    ...
                    aPlaylistController._iPlaylistControllerCommands.cmd_createZone(zoneId, //zoneId : number, 
            ...
            RE_PlaylistItem_StatusEnd.prototype.notifyChildEnd = function (event, eventQueue, error, aPlaylistController, aRenderingController, context, callback) {
                if (this.getDiagram().getOwner().getParent() == null)
                    return;
                this.postEvent(amPlaylistItemEventType.am_coreservices.AE_PlaylistItemEventType.EVT_notifyChildEnd, this.getDiagram().getOwner().getParent().getLogic(), null, this.getDiagram().getOwnerIdxAsChild(), 
