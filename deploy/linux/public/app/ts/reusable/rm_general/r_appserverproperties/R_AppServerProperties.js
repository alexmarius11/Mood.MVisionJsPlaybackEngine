...
define(["require", "exports", "../../../../../app/ts/reusable/rm_general/r_entity/R_Entity"], function (require, exports, rmGeneralEntity) {
    ...
    var rm_general;
    (function (rm_general) {
        var R_AppServerProperties = /** @class */ (function (_super) {
            ...
            function R_AppServerProperties() {
                ...
                _this._appLaunchMode = "local"; //üsb"/"remote";////Configuration.AppMode.LOCAL; //REMOTE, USB
                _this._fqdnMode = false;
                _this._fqdnAddr = ""; //"http://signage.domain.com/index.html";  
                return _this;
            }
            //--------------------------------
