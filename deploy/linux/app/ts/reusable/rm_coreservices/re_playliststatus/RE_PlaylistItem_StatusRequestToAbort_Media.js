...
var rmPlaylistItemStatus = require("../../../../../app/ts/reusable/rm_coreservices/re_playliststatus/RE_PlaylistItem_StatusRequestToAbort");
var rm_coreservices;
(function (rm_coreservices) {
    var RE_PlaylistItem_StatusRequestToAbort_Media = (function (_super) {
        __extends(RE_PlaylistItem_StatusRequestToAbort_Media, _super);
        function RE_PlaylistItem_StatusRequestToAbort_Media() {
            var _this = _super.call(this) || this;
            _this._statusName = "REQUEST-TO-ABORT_MEDIA";
            return _this;
        }
        RE_PlaylistItem_StatusRequestToAbort_Media.prototype.injectDependencies = function (aSrvContainer, aSrvLocator, aSrvLog, error) {
            _super.prototype.injectDependencies.call(this, aSrvContainer, aSrvLocator, aSrvLog, error);
            return 0;
        };
        RE_PlaylistItem_StatusRequestToAbort_Media.prototype.reset = function () {
        };
        RE_PlaylistItem_StatusRequestToAbort_Media.prototype.passToMe = function (event, eventQueue, error, aPlaylistController, aRenderingController, context, callback) {
        ...
        RE_PlaylistItem_StatusRequestToAbort_Media.prototype.startMediaAbortAndPassedToEndStatus = function (event, eventQueue, error, aPlaylistController, aRenderingController, context, callback) {
            var self = this;
        ...
        RE_PlaylistItem_StatusRequestToAbort_Media.prototype.receiveEvent = function (event, eventQueue, error, aPlaylistController, aRenderingController, context, callback) {
        ...
        return RE_PlaylistItem_StatusRequestToAbort_Media;
    }(rmPlaylistItemStatus.rm_coreservices.RE_PlaylistItem_StatusRequestToAbort));
    rm_coreservices.RE_PlaylistItem_StatusRequestToAbort_Media = RE_PlaylistItem_StatusRequestToAbort_Media;
})(rm_coreservices = exports.rm_coreservices || (exports.rm_coreservices = {}));
//# sourceMappingURL=RE_PlaylistItem_StatusRequestToAbort_Media.js.map