...
var rm_general;
(function (rm_general) {
    var R_PowerSaveModeInfo = (function (_super) {
        __extends(R_PowerSaveModeInfo, _super);
        function R_PowerSaveModeInfo() {
            var _this = _super.call(this) || this;
            _this._enabledSmartEnergySaving = false;
            _this._displayPowerMngMode = "off";
            _this._automaticStandbyMode = "off";
            _this._enabled15MinOff = false;
            return _this;
        }
