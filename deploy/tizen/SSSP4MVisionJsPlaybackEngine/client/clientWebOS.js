define(["require", "exports", "../app/ts/reusable/rm_configurationservices/r_servicelocator/R_ServiceLocator", "../app/ts/native/nm_transversalservices/n_sdk_webos/N_SDK_WebOS", "../app/ts/reusable/rm_renderingservices/r_sdkrenderer/R_SDKRenderer", "../app/ts/reusable/rm_transversalservices/r_sdk_connector/R_SDK_Connector", "../app/ts/reusable/rm_transversalservices/r_utilsservice/R_UtilsService", "../app/ts/reusable/rm_transversalservices/r_xmlconfigurator/R_XmlConfigurator", "../app/ts/abstract/am_renderingservices/ae_renderparams/AE_RenderParams_ImageDisplayTypeEnum", "../app/ts/abstract/am_renderingservices/ae_renderparams/AE_RenderParams_MediaTypeEnum", "../app/ts/reusable/rm_coreservices/r_playlistcontroller/R_PlaylistController", "../app/ts/reusable/rm_coreservices/r_renderingcontroller/R_RenderingController", "../app/ts/reusable/rm_transversalservices/r_logservice/R_LogService", "../app/ts/reusable/rm_renderingservices/r_logrenderer/R_LogRenderer", "../app/ts/reusable/rm_transversalservices/r_log_connector/R_Log_Connector"], function (require, exports, rmConfigurationServicesServiceLocator, nmodSDKWebOS, rmodSDKRenderer, rmodSDKConnector, rmodUtilsService, rmodXmlConfigurator, amImageDisplayTypeEnum, amMediaTypeEnum, rmPlaylistController, rmRenderingController, rmodLogService, rmodLogRenderer, rmodLogConnector) {
    "use strict";
    ...
    */
    ...
    var aSDKJsTV = new nmodSDKWebOS.nm_transversalservices.N_SDK_WebOS(null, null, null, error);
        ...
        try {
            var callbackLoadXMLFiles = function callbackLoadXMLFiles(ctx) {
                if ((ctx._error != null) && (ctx._error._id != null) && (ctx._error._id != 0)) {
                    ...
                    aLogService._iLogMain.log(4, "clientNodejs" + "\t\t" + "Load XML Files : failed", error, context, callbackLog3);
                    return;
                }
                ...
                var callbackGetXmlObjectsHS = function callbackGetXmlObjectsHS(ctxH) {
                    ...
                    aXmlConfigurator._iXmlConfiguratorMain.getXmlJsonObject(aXMLFileOH.getStorage(), aXMLFileOH.getPath(), aXMLFileOH.getName(), errorOH, contextOH, callbackGetXmlObjectsOH);
                };
...
//});
//# sourceMappingURL=clientWebOS.js.map