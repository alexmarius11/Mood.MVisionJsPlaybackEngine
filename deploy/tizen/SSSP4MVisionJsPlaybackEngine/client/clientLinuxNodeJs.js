...
define(["require", "exports", "../app/ts/reusable/rm_configurationservices/r_servicelocator/R_ServiceLocator", "../app/ts/reusable/rm_transversalservices/r_sdk_client/R_SDK_Client", "../app/ts/reusable/rm_renderingservices/r_sdkrenderer/R_SDKRenderer", "../app/ts/reusable/rm_transversalservices/r_sdk_connector/R_SDK_Connector", "../app/ts/reusable/rm_transversalservices/r_utilsservice/R_UtilsService", "../app/ts/reusable/rm_transversalservices/r_log_client/R_Log_Client", "../app/ts/reusable/rm_renderingservices/r_logrenderer/R_LogRenderer", "../app/ts/reusable/rm_transversalservices/r_log_connector/R_Log_Connector", "../app/ts/reusable/rm_transversalservices/r_xmlconfigurator/R_XmlConfigurator", "../app/ts/abstract/am_renderingservices/ae_renderparams/AE_RenderParams_ImageDisplayTypeEnum", "../app/ts/abstract/am_renderingservices/ae_renderparams/AE_RenderParams_MediaTypeEnum", "../app/ts/reusable/rm_coreservices/r_playlistcontroller/R_PlaylistController", "../app/ts/reusable/rm_coreservices/r_renderingcontroller/R_RenderingController"], function (require, exports, rmConfigurationServicesServiceLocator, rmodSDKClient, rmodSDKRenderer, rmodSDKConnector, rmodUtilsService, rmodLogClient, rmodLogRenderer, rmodLogConnector, rmodXmlConfigurator, amImageDisplayTypeEnum, amMediaTypeEnum, rmPlaylistController, rmRenderingController) {
    ...
    function _getDefaultResourceStorageUrlName() {
        return "http://127.0.0.1:9080/ux/"; //"http://192.168.0.222:9080/ux/";
    }
    //-------------------------------------------
    function _getDefaultStorageUrlName() {
        return "http://127.0.0.1:3000"; //"http://192.168.0.222:3000"; 
    }
    //---------------------------------------------
    function _getDefaultStorageSameDomainUrlName() {
        return "http://127.0.0.1:3000/ux/"; //"http://192.168.0.222:3000/ux/"; 
    }
    var __socket = io(_getDefaultStorageUrlName()); //"http://localhost:3000");
    //-- the variables
    var error = null;
    var aSrvLocator;
    ...
    aStartFileFolder.setStorage(_getDefaultResourceStorageName()); //"/");
    aStartFileFolder.setPath("");
    aStartUrlFileFolder.setStorage(_getDefaultResourceStorageUrlName()); //"http://127.0.0.1:9080/ux/");
    aStartUrlFileFolder.setPath("");
    aStartUrlDomainFileFolder.setStorage(_getDefaultStorageSameDomainUrlName()); //"http://127.0.0.1:3000/ux/");
...
//});
//# sourceMappingURL=clientLinuxNodeJs.js.map