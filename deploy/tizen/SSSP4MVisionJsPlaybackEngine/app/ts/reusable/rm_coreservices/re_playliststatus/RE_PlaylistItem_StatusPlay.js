...
define(["require", "exports", "../../../../../app/ts/reusable/rm_coreservices/re_playliststatus/RE_PlaylistItem_Status"], function (require, exports, rmPlaylistItemStatus) {
    ...
    (function (rm_coreservices) {
        var RE_PlaylistItem_StatusPlay = /** @class */ (function (_super) {
            __extends(RE_PlaylistItem_StatusPlay, _super);
            //----------------
            function RE_PlaylistItem_StatusPlay() {
                var _this = _super.call(this) || this;
                _this._transitionTo_StatusEnd_or_Similar = null;
                _this._transitionTo_StatusRequestToPlay = null;
                _this._transitionTo_StatusError = null;
                _this._transitionTo_StatusRequestToSuspend = null;
            ...
            //------------------------------
            RE_PlaylistItem_StatusPlay.prototype.injectDependencies = function (aSrvContainer, aSrvLocator, aSrvLog, error) {
            ...
            return RE_PlaylistItem_StatusPlay;
        }(rmPlaylistItemStatus.rm_coreservices.RE_PlaylistItem_Status));
        rm_coreservices.RE_PlaylistItem_StatusPlay = RE_PlaylistItem_StatusPlay;
    })(rm_coreservices = exports.rm_coreservices || (exports.rm_coreservices = {}));
});
//# sourceMappingURL=RE_PlaylistItem_StatusPlay.js.map