...
define(["require", "exports", "../../../../../app/ts/reusable/rm_general/r_entity/R_Entity"], function (require, exports, rmGeneralEntity) {
    ...
    var rm_general;
    (function (rm_general) {
        var R_SystemMonitorInfo = /** @class */ (function (_super) {
            __extends(R_SystemMonitorInfo, _super);
            //----------- constructor 
            function R_SystemMonitorInfo() {
                var _this = _super.call(this) || this;
                _this._fan = false; //: true,
                _this._signal = false; //: true,
                _this._lamp = false; //:true
                _this._screen = false; //: true;
                _this._temperature = false; //: true
