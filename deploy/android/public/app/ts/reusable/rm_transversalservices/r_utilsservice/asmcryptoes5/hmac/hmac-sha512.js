...
define(["require", "exports", "./hmac", "../other/errors", "../hash/sha512/sha512"], function (require, exports, hmac_1, errors_1, sha512_1) {
    "use strict";
    ...
    var HmacSha512 = /** @class */ (function (_super) {
        ...
        HmacSha512.prototype.finish = function () {
            ...
            var result = new Uint8Array(sha512_1._sha512_hash_size);
            result.set(heap.subarray(0, sha512_1._sha512_hash_size));
            if (verify) {
