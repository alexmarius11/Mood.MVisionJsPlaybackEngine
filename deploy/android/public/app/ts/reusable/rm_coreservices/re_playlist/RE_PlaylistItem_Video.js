...
define(["require", "exports", "../../../../../app/ts/reusable/rm_coreservices/re_playlist/RE_PlaylistItem"], function (require, exports, rmCoreServicesPlaylistItem) {
    ...
    (function (rm_coreservices) {
        var RE_PlaylistItem_Video = /** @class */ (function (_super) {
            __extends(RE_PlaylistItem_Video, _super);
            //----------------
            function RE_PlaylistItem_Video() {
                var _this = _super.call(this) || this;
                _this._playlistItemTypeName = "VIDEO";
                //------------------ metadata
            ...
            //------------------------------
            RE_PlaylistItem_Video.prototype.loadProperties = function (playlistType, jsonObject, aPlaylistFile, aParent, error, context, callback) {
            ...
            //------------------------------
            RE_PlaylistItem_Video.prototype.loadProperties_MoodV5 = function (playlistType, jsonObject, aPlaylistFile, aParent, error, context, callback) {
            };
            //------------------------------
            RE_PlaylistItem_Video.prototype.loadProperties_CustomV1 = function (playlistType, jsonObject, aPlaylistFile, aParent, error, context, callback) {
            };
            //-----------------------------------------------------
            RE_PlaylistItem_Video.prototype.toJSONString = function () {
                var result = "{";
            ...
            return RE_PlaylistItem_Video;
        }(rmCoreServicesPlaylistItem.rm_coreservices.RE_PlaylistItem));
        rm_coreservices.RE_PlaylistItem_Video = RE_PlaylistItem_Video;
    })(rm_coreservices = exports.rm_coreservices || (exports.rm_coreservices = {}));
});
//# sourceMappingURL=RE_PlaylistItem_Video.js.map