...
import amGeneral3 = require("../../../../../app/ts/abstract/am_general/a_entity/AFactory_Entity");

export module am_general
{
  export interface AFactory_Property extends amGeneral3.am_general.AFactory_Entity
  {
