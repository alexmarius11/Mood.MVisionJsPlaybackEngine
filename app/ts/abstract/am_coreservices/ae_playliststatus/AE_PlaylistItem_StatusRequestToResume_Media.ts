...
import amPlaylistItemStatus  = require("../../../../../app/ts/abstract/am_coreservices/ae_playliststatus/AE_PlaylistItem_StatusRequestToResume");
...
{
  export interface AE_PlaylistItem_StatusRequestToResume_Media extends amPlaylistItemStatus.am_coreservices.AE_PlaylistItem_StatusRequestToResume
  {
