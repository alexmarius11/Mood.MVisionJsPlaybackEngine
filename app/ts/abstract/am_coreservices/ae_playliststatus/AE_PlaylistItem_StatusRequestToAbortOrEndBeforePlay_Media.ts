...
import amPlaylistItemStatus  = require("../../../../../app/ts/abstract/am_coreservices/ae_playliststatus/AE_PlaylistItem_StatusRequestToAbortOrEndBeforePlay");
...
{
  export interface AE_PlaylistItem_StatusRequestToAbortOrEndBeforePlay_Media extends amPlaylistItemStatus.am_coreservices.AE_PlaylistItem_StatusRequestToAbortOrEndBeforePlay
  {
