...
import amPlaylistItemStatus  = require("../../../../../app/ts/abstract/am_coreservices/ae_playliststatus/AE_PlaylistItem_StatusRequestToAbort");
...
{
  export interface AE_PlaylistItem_StatusRequestToAbort_Media extends amPlaylistItemStatus.am_coreservices.AE_PlaylistItem_StatusRequestToAbort
  {
