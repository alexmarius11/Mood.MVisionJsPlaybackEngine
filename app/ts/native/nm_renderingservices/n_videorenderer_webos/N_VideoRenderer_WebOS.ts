...
import nmIVideoRendererWebOS    = require("../../../../../app/ts/native/nm_renderingservices/n_videorenderer_webos/IImpl_VideoRenderer_WebOS");
...
{
  export class N_VideoRenderer_WebOS extends rmRenderingServices.rm_renderingservices.R_RenderingService 
                                     implements amRenderingServices.am_renderingservices.A_VideoRenderer
  {
    ...
    {      
      ...
      this._iVideoRenderer = new nmIVideoRendererWebOS.nm_renderingservices.IImpl_VideoRenderer_WebOS(this) ;
