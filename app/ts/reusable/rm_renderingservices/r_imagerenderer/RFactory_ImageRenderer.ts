...
import mod_R_ImageRenderer  = require("../../../../../app/ts/reusable/rm_renderingservices/r_imagerenderer/R_ImageRenderer");

export module rm_renderingservices
{
  export class RFactory_ImageRenderer   extends rmGeneralServiceFactory.rm_general.RFactory_Service 
