...
import amFactoryRenderParametersVideo = require("../../../../../app/ts/abstract/am_renderingservices/ae_renderparams/AEFactory_RenderParams_Video");
...
{
  export class RFactory_RenderParameters_Video extends   rmGeneralEntityFactory.rm_general.RFactory_Entity
                                               implements amFactoryRenderParametersVideo.am_renderingservices.AEFactory_RenderParams_Video
  {
