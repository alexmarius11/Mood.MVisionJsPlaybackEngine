...
import mod_R_SDKRenderer  = require("../../../../../app/ts/reusable/rm_renderingservices/r_sdkrenderer/R_SDKRenderer");

export module rm_renderingservices
{
  export class RFactory_SDKRenderer   extends rmGeneralServiceFactory.rm_general.RFactory_Service 
