import amRenderingServicesHardwareSetupRenderer = require("../../../../../app/ts/abstract/am_renderingservices/a_sdkrenderer/I_SDKRenderer_HardwareSetup");
...
{
  export class IImpl_SDKRenderer_HardwareSetup_R implements amRenderingServicesHardwareSetupRenderer.am_renderingservices.I_SDKRenderer_HardwareSetup
  {
    _name: string;    
