import amRenderingServicesAudioSetupRenderer = require("../../../../../app/ts/abstract/am_renderingservices/a_sdkrenderer/I_SDKRenderer_AudioSetup");
...
{
  export class IImpl_SDKRenderer_AudioSetup_R implements amRenderingServicesAudioSetupRenderer.am_renderingservices.I_SDKRenderer_AudioSetup
  {
    _name: string;    
