import amRenderingServicesSDKMainRenderer = require("../../../../../app/ts/abstract/am_renderingservices/a_sdkrenderer/I_SDKRenderer_Main");
...
{
  export class IImpl_SDKRenderer_Main_R implements amRenderingServicesSDKMainRenderer.am_renderingservices.I_SDKRenderer_Main
  {
    _name: string;    
