import amRenderingServicesApplicationSetupRenderer = require("../../../../../app/ts/abstract/am_renderingservices/a_sdkrenderer/I_SDKRenderer_ApplicationSetup");
...
{
  export class IImpl_SDKRenderer_ApplicationSetup_R implements amRenderingServicesApplicationSetupRenderer.am_renderingservices.I_SDKRenderer_ApplicationSetup
  {
    _name: string;    
