import amRenderingServicesTimeSetupRenderer = require("../../../../../app/ts/abstract/am_renderingservices/a_sdkrenderer/I_SDKRenderer_TimeSetup");
...
{
  export class IImpl_SDKRenderer_TimeSetup_R implements amRenderingServicesTimeSetupRenderer.am_renderingservices.I_SDKRenderer_TimeSetup
  {
    _name: string;    
