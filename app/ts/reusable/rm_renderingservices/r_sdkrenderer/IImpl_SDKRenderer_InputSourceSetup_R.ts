import amRenderingServicesInputSourceSetupRenderer = require("../../../../../app/ts/abstract/am_renderingservices/a_sdkrenderer/I_SDKRenderer_InputSourceSetup");
...
{
  export class IImpl_SDKRenderer_InputSourceSetup_R implements amRenderingServicesInputSourceSetupRenderer.am_renderingservices.I_SDKRenderer_InputSourceSetup
  {
    _name: string;    
