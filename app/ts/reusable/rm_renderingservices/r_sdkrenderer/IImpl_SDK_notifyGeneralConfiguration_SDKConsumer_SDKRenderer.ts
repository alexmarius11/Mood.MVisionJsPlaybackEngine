...
{
  export class IImpl_SDK_notifyGeneralConfiguration_SDKConsumer_SDKRenderer implements amGeneral.am_transversalservices.I_SDK_notifyGeneralConfiguration
  {
    //----------- properties
    _name: string;  
