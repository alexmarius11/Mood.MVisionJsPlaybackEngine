import amRenderingServicesGeneralConfigurationRenderer = require("../../../../../app/ts/abstract/am_renderingservices/a_sdkrenderer/I_SDKRenderer_GeneralConfiguration");
...
{
  export class IImpl_SDKRenderer_GeneralConfiguration_R implements amRenderingServicesGeneralConfigurationRenderer.am_renderingservices.I_SDKRenderer_GeneralConfiguration
  {
    _name: string;    
