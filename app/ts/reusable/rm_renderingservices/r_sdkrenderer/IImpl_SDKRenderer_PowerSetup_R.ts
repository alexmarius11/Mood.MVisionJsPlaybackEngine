import amRenderingServicesPowerSetupRenderer = require("../../../../../app/ts/abstract/am_renderingservices/a_sdkrenderer/I_SDKRenderer_PowerSetup");
...
{
  export class IImpl_SDKRenderer_PowerSetup_R implements amRenderingServicesPowerSetupRenderer.am_renderingservices.I_SDKRenderer_PowerSetup
  {
    _name: string;    
