import amRenderingServicesTvSignageSetupRenderer = require("../../../../../app/ts/abstract/am_renderingservices/a_sdkrenderer/I_SDKRenderer_TvSignageSetup");
...
{
  export class IImpl_SDKRenderer_TvSignageSetup_R implements amRenderingServicesTvSignageSetupRenderer.am_renderingservices.I_SDKRenderer_TvSignageSetup
  {
    _name: string;    
