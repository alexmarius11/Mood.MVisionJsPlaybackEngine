...
{
  export class RE_ControlParams_Run extends rmGeneralEntity.rm_general.R_Entity
                                        implements amControlRunParams.am_renderingservices.AE_ControlParams_Run
  {
    ...
    //-----------------------------------------------
    public copy(src : amControlRunParams.am_renderingservices.AE_ControlParams_Run) : number
    {
      return 0;
    }
