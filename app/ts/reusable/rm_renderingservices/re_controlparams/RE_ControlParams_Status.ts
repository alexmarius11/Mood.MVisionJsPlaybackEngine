...
{
  export class RE_ControlParams_Status extends rmGeneralEntity.rm_general.R_Entity
                               implements amControlStatusParams.am_renderingservices.AE_ControlParams_Status
  {
    ...
    //-----------------------------------------------
    public copy(src : amControlStatusParams.am_renderingservices.AE_ControlParams_Status) : number
    {
      return 0;
    }
