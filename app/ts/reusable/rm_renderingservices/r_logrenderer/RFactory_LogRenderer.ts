...
//import * as mod_R_ImageRenderer from "../../../../../app/ts/reusable/rm_renderingservices/r_sdkrenderer/R_SDKRenderer";
import mod_R_LogRenderer  = require("../../../../../app/ts/reusable/rm_renderingservices/r_logrenderer/R_LogRenderer");

export module rm_renderingservices
{
  export class RFactory_LogRenderer   extends rmGeneralServiceFactory.rm_general.RFactory_Service 
                                             implements amGeneralServiceFactory.am_general.AFactory_Service
  {
                             ...
                             : amGeneralService.am_general.A_Service
    {
      ...
      //{  
        return new mod_R_LogRenderer.rm_renderingservices.R_LogRenderer(aFactoryDescription, aServiceContainer, aLogService, error); 
      //});
