...
import mod_R_HtmlTemplateRenderer  = require("../../../../../app/ts/reusable/rm_renderingservices/r_htmltemplaterenderer/R_HtmlTemplateRenderer");

export module rm_renderingservices
{
  export class RFactory_HtmlTemplateRenderer   extends rmGeneralServiceFactory.rm_general.RFactory_Service 
