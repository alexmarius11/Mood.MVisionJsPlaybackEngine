...
import mod_R_TvHdmiPassThroughSrv  = require("../../../../../app/ts/reusable/rm_renderingservices/r_tvhdmipassthroughsrv/R_TvHdmiPassThroughSrv");

export module rm_renderingservices
{
  export class RFactory_TvHdmiPassThroughSrv   extends rmGeneralServiceFactory.rm_general.RFactory_Service 
