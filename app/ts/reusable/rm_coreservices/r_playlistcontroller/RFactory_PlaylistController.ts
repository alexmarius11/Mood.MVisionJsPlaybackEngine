...
import mod_R_PlaylistController  = require("../../../../../app/ts/reusable/rm_coreservices/r_playlistcontroller/R_PlaylistController");

export module rm_coreservices
{
  export class RFactory_PlaylistController extends rmGeneralServiceFactory.rm_general.RFactory_Service 
