import amCoreServicesIPlaylistControllerPlaylistMoodv5 = require("../../../../../app/ts/abstract/am_coreservices/a_playlistcontroller/I_PlaylistController_Playlist_Mood_v5");
...
import amPlaylistItemTag      = require("../../../../../app/ts/abstract/am_coreservices/ae_playlist/AE_PlaylistItem_Tag");
import amPlaylistItemTagLogic = require("../../../../../app/ts/abstract/am_coreservices/ae_playlist/AE_PlaylistItem_TagLogic");
...
import amJsonMediaTypeId = require("../../../../../app/ts/abstract/am_coreservices/ae_playlist/AE_JsonMediaTypeId");
...
{
  export class IImpl_PlaylistController_Playlist_Mood_v5 implements  amCoreServicesIPlaylistControllerPlaylistMoodv5.am_coreservices.I_PlaylistController_Playlist_Mood_v5
  {
    _name: string;    
                         ...
                         error: amGeneralError.am_general.A_Error, context: amGeneralContext.am_general.A_Context, callback)
    {
      ...
      */      
      ...
      prepareParams.getRenderParams().getParamContainerPosSize().setAllPosAndSizesInPercentages(
                                                                   0.0, 0.0, 1.0, 1.0,  
                                                                   -1, -1, -1, -1,
                                                                   this._owner._iPlaylistControllerConfig.getScreenProperties().getScreenLeft(),
                                                                   this._owner._iPlaylistControllerConfig.getScreenProperties().getScreenTop(),
                                                                   this._owner._iPlaylistControllerConfig.getScreenProperties().getScreenRight(),
                                                                   this._owner._iPlaylistControllerConfig.getScreenProperties().getScreenBottom(),
                                                                   );
    ...
    //-------------------------------------------------------------------
    public loadStreams( aPlaylistType: string, jsonObject : any, aPlaylistFile: amGeneralFileInfo.am_general.A_FileInfo,
                        aParent: amPlaylistContainer.am_coreservices.AE_PlaylistItem_Container,
                        error: amGeneralError.am_general.A_Error, context: amGeneralContext.am_general.A_Context, callback)
    {
      //-------------------- load Streams
    ...
    //-------------------------------------------------------------------
    public loadOneStream( aPlaylistType: string, jsonObject : any, aPlaylistFile: amGeneralFileInfo.am_general.A_FileInfo, iStream: number,
                          aParent: amPlaylistContainer.am_coreservices.AE_PlaylistItem_Container,
                          error: amGeneralError.am_general.A_Error, context: amGeneralContext.am_general.A_Context, callback)
    {
      ...
      var prepareParams = this._owner._aServiceLocator._iEntityCreation.createDefaultControlPrepareParams(error);
      prepareParams.injectDependencies(this._owner._aServiceContainer, this._owner._aServiceLocator, this._owner._aLogService, error);
      prepareParams.getRenderParams().getParamContainerPosSize().setOrigAllPosAndSizesInPercentages( percX,  percY, percX+percWidth, percY+percHeight,
                                                                                                         0,      0,       percWidth,       percHeight);
      prepareParams.getRenderParams().getParamContainerPosSize().setAllPosAndSizesInPercentages(
                                                                   percX*0.01, percY*0.01,   (percX+percWidth)*0.01, (percY+percHeight)*0.01,
                                                                   -1, -1, -1, -1,
                                                                   this._owner._iPlaylistControllerConfig.getScreenProperties().getScreenLeft(),
                                                                   this._owner._iPlaylistControllerConfig.getScreenProperties().getScreenTop(),
                                                                   this._owner._iPlaylistControllerConfig.getScreenProperties().getScreenRight(),
      ...
      prepareParams.getRenderParams().getParamContainerAdjustedPosSize().setOrigAllPosAndSizesInPercentages( percX,  percY, percX+percWidth, percY+percHeight,
                                                                                                                 0,      0,       percWidth,       percHeight);
      prepareParams.getRenderParams().getParamContainerAdjustedPosSize().setAllPosAndSizesInPercentages(
                                                                   percX*0.01, percY*0.01,   (percX+percWidth)*0.01, (percY+percHeight)*0.01,
                                                                   -1, -1, -1, -1,
      ...
      crtPlaylistStreamLogic.setDiffusionInfos( crtPlaylistStream._diff_duration, crtPlaylistStream._diff_startDate, crtPlaylistStream._diff_endDate,
                                                crtPlaylistStream._diff_startTime, crtPlaylistStream._diff_endTime,  crtPlaylistStream._diff_weekdays);
      ...
      //------------------
      this.loadEvents(aPlaylistType, jsonObject.Channel_Extended, aPlaylistFile, 0,
                      crtPlaylistStream, error, context, callback);

      //------------------
      this.loadStaticMediaItems(aPlaylistType, jsonObject.Channel_Extended, aPlaylistFile, 
                                crtPlaylistStream, error, context, callback);

      //------------------
      var iStream = 0;
      this.loadOnePlaylist(aPlaylistType, jsonObject.Channel_Extended.Playlist_Extended, aPlaylistFile, 
                           iStream, crtPlaylistStream, error, context, callback);

      //------------------
      this.loadScreenSaver(aPlaylistType, jsonObject.Channel_Extended, aPlaylistFile, 1,
                            crtPlaylistStream, error, context, callback);
    ...
    //-------------------------------------------------------------------
    public loadScreenSaver( aPlaylistType: string, jsonObject : any, aPlaylistFile: amGeneralFileInfo.am_general.A_FileInfo, iScreenSaverIdx: number,
                            aParent: amPlaylistContainer.am_coreservices.AE_PlaylistItem_Container,
                            error: amGeneralError.am_general.A_Error, context: amGeneralContext.am_general.A_Context, callback)
    {
      ...
      var aScreenSaverConfig:amPlaybackScreenSaverConfig.am_playback.AE_ScreenSaverConfig = playlistGlobalConfig.getScreenSaverConfig();
    ...
    //-------------------------------------------------------------------
    public loadScreenSaverImage( aPlaylistType: string, jsonObject : any, aPlaylistFile: amGeneralFileInfo.am_general.A_FileInfo, iScreenSaverIdx: number,
                                 aParent: amPlaylistContainer.am_coreservices.AE_PlaylistItem_Container,
                                 error: amGeneralError.am_general.A_Error, context: amGeneralContext.am_general.A_Context, callback)
    {
      ...
      crtPlaylistItemScreenSaverImageLogic.setDiffusionInfos( 
                        crtPlaylistItemScreenSaverImage._diff_duration,  crtPlaylistItemScreenSaverImage._diff_startDate, crtPlaylistItemScreenSaverImage._diff_endDate,
                        crtPlaylistItemScreenSaverImage._diff_startTime, crtPlaylistItemScreenSaverImage._diff_endTime,   crtPlaylistItemScreenSaverImage._diff_weekdays);
      ...
      prepareParams.getRenderParams().getParamIdentification().setMediaType(
                                                                amMediaTypeEnum.am_renderingservices.AE_RenderParams_MediaTypeEnum.MediaType_ScreenSaver);
      ...
      var aScreenSaverConfig:amPlaybackScreenSaverConfig.am_playback.AE_ScreenSaverConfig = null;
      if (playlistGlobalConfig != null)
      {
      ...
      //---
      prepareParams.getRenderParams().getParamContainerPosSize().setAllPosAndSizes(
                                      ancestorWithRenderingZone.getPrepareParams().getRenderParams().getParamContainerPosSize().getContainerLeft(),
                                      ancestorWithRenderingZone.getPrepareParams().getRenderParams().getParamContainerPosSize().getContainerTop(),
                                      ancestorWithRenderingZone.getPrepareParams().getRenderParams().getParamContainerPosSize().getContainerRight(),
                                      ancestorWithRenderingZone.getPrepareParams().getRenderParams().getParamContainerPosSize().getContainerBottom(),
                                      -1, -1, -1, -1);
      prepareParams.getRenderParams().getParamContainerAdjustedPosSize().setAllPosAndSizes(
                                      ancestorWithRenderingZone.getPrepareParams().getRenderParams().getParamContainerPosSize().getContainerLeft(),
                                      ancestorWithRenderingZone.getPrepareParams().getRenderParams().getParamContainerPosSize().getContainerTop(),
                                      ancestorWithRenderingZone.getPrepareParams().getRenderParams().getParamContainerPosSize().getContainerRight(),
                                      ancestorWithRenderingZone.getPrepareParams().getRenderParams().getParamContainerPosSize().getContainerBottom(),
                                      -1, -1, -1, -1);
      prepareParams.getRenderParams().getParamContainerPosSize().setContainerZOrder(
    ...
    //-------------------------------------------------------------------
    public loadScreenSaverVideo( aPlaylistType: string, jsonObject : any, aPlaylistFile: amGeneralFileInfo.am_general.A_FileInfo, iScreenSaverIdx: number,
                                 aParent: amPlaylistContainer.am_coreservices.AE_PlaylistItem_Container,
                                 error: amGeneralError.am_general.A_Error, context: amGeneralContext.am_general.A_Context, callback)
    {
      ...
      crtPlaylistItemScreenSaverVideoLogic.setDiffusionInfos( 
                          crtPlaylistItemScreenSaverVideo._diff_duration,  crtPlaylistItemScreenSaverVideo._diff_startDate, crtPlaylistItemScreenSaverVideo._diff_endDate,
                          crtPlaylistItemScreenSaverVideo._diff_startTime, crtPlaylistItemScreenSaverVideo._diff_endTime,   crtPlaylistItemScreenSaverVideo._diff_weekdays);
    ...
    //-------------------------------------------------------------------
    public loadStaticMediaItems( aPlaylistType: string, jsonObject : any, aPlaylistFile: amGeneralFileInfo.am_general.A_FileInfo, 
                                 aParent: amPlaylistContainer.am_coreservices.AE_PlaylistItem_Container,
                                 error: amGeneralError.am_general.A_Error, context: amGeneralContext.am_general.A_Context, callback)
    {
       ...
       //------------------
       (<amPlaylistItemStream.am_coreservices.AE_PlaylistItem_Stream>aParent).setStaticMediaItems(crtStaticMediaItems);  
       return;
    ...
    //-------------------------------------------------------------------
    public loadEvents( aPlaylistType: string, jsonObject : any, aPlaylistFile: amGeneralFileInfo.am_general.A_FileInfo, iEventsIdx: number,
                       aParent: amPlaylistContainer.am_coreservices.AE_PlaylistItem_Container,
                       error: amGeneralError.am_general.A_Error, context: amGeneralContext.am_general.A_Context, callback)
    {
      ...
      //------------------
      (<amPlaylistItemStream.am_coreservices.AE_PlaylistItem_Stream>aParent).setEvents(crtItemEvents);
      ...
      crtItemEventsLogic.setDiffusionInfos( 
                      crtItemEvents._diff_duration,  crtItemEvents._diff_startDate, crtItemEvents._diff_endDate,
                      crtItemEvents._diff_startTime, crtItemEvents._diff_endTime,   crtItemEvents._diff_weekdays);
    ...
    //-------------------------------------------------------------------
    public loadOneEvent( aPlaylistType: string, jsonObject : any, aPlaylistFile: amGeneralFileInfo.am_general.A_FileInfo, iEventItem: number, 
                         aParent: amPlaylistContainer.am_coreservices.AE_PlaylistItem_Container,
                         error: amGeneralError.am_general.A_Error, context: amGeneralContext.am_general.A_Context, callback)
    {
        ...
        crtItemEventLogic.setDiffusionInfos( 
                      crtItemEvent._diff_duration,  crtItemEvent._diff_startDate, crtItemEvent._diff_endDate,
                      crtItemEvent._diff_startTime, crtItemEvent._diff_endTime,   crtItemEvent._diff_weekdays);
    ...
    //-------------------------------------------------------------------
    public loadOnePlaylist( aPlaylistType: string, jsonObject : any, aPlaylistFile: amGeneralFileInfo.am_general.A_FileInfo, iPlaylist: number,
                            aParent: amPlaylistContainer.am_coreservices.AE_PlaylistItem_Container,
                            error: amGeneralError.am_general.A_Error, context: amGeneralContext.am_general.A_Context, callback)
    {
      ...
      crtItemPlaylistLogic.setDiffusionInfos( 
                      crtItemPlaylist._diff_duration,  crtItemPlaylist._diff_startDate, crtItemPlaylist._diff_endDate,
                      crtItemPlaylist._diff_startTime, crtItemPlaylist._diff_endTime,   crtItemPlaylist._diff_weekdays);
      ...
      var isRandom:boolean = jsonObject.IsRandom;
      if (isRandom)
      {
        if (crtItemPlaylistLogic.cmd_getNbChildren() > 0)
        {
          ...
          crtItemPlaylistLogic.cmd_setNextChildSelectionType(
                                     amNextChildSelectionType.am_coreservices.AE_NextChildSelectionType.NextChildSelectionType_Random_NoLoop_WithDiffusion);
        }
        //
    ...
    //-------------------------------------------------------------------
    public loadMediaItems( aPlaylistType: string, jsonObject : any, aPlaylistFile: amGeneralFileInfo.am_general.A_FileInfo,
                           aParent: amPlaylistContainer.am_coreservices.AE_PlaylistItem_Container,
                           error: amGeneralError.am_general.A_Error, context: amGeneralContext.am_general.A_Context, callback)
    {
      //-------------------- load Media Items
   ...
   //-------------------------------------------------------------------
    public loadOneMediaItem( aPlaylistType: string, jsonObject : any, aPlaylistFile: amGeneralFileInfo.am_general.A_FileInfo, iMediaItem: number,
                            aParent: amPlaylistContainer.am_coreservices.AE_PlaylistItem_Container,
                            error: amGeneralError.am_general.A_Error, context: amGeneralContext.am_general.A_Context, callback)
    {
      //-------------------
...
//-------------------------------------------------------------------
public loadOneImage( aPlaylistType: string, jsonObject : any, aPlaylistFile: amGeneralFileInfo.am_general.A_FileInfo, iMediaItem: number,
    aParent: amPlaylistContainer.am_coreservices.AE_PlaylistItem_Container,
    error: amGeneralError.am_general.A_Error, context: amGeneralContext.am_general.A_Context, callback)
{
    //----- case amJsonMediaTypeId.am_coreservices.AE_JsonMediaTypeId.MEDIA_STATIC:
    ...
    crtPlaylistItemImageLogic.setDiffusionInfos( 
                      crtPlaylistItemImage._diff_duration,  crtPlaylistItemImage._diff_startDate, crtPlaylistItemImage._diff_endDate,
                      crtPlaylistItemImage._diff_startTime, crtPlaylistItemImage._diff_endTime,   crtPlaylistItemImage._diff_weekdays);
    ...
    prepareParams.getRenderParams().getParamIdentification().setMediaType(
                                    amMediaTypeEnum.am_renderingservices.AE_RenderParams_MediaTypeEnum.MediaType_Image);
...
//-------------------------------------------------------------------
public loadOneVideo( aPlaylistType: string, jsonObject : any, aPlaylistFile: amGeneralFileInfo.am_general.A_FileInfo, iMediaItem: number,
                     aParent: amPlaylistContainer.am_coreservices.AE_PlaylistItem_Container,
                     error: amGeneralError.am_general.A_Error, context: amGeneralContext.am_general.A_Context, callback)
{
  //--------------- case amJsonMediaTypeId.am_coreservices.AE_JsonMediaTypeId.MEDIA_STATIC_MOVIE:
  ...
  crtPlaylistItemVideoLogic.setDiffusionInfos( 
                      crtPlaylistItemVideo._diff_duration,  crtPlaylistItemVideo._diff_startDate, crtPlaylistItemVideo._diff_endDate,
                      crtPlaylistItemVideo._diff_startTime, crtPlaylistItemVideo._diff_endTime,   crtPlaylistItemVideo._diff_weekdays);
  ...
  prepareParams.getRenderParams().getParamIdentification().setMediaType(
                                  amMediaTypeEnum.am_renderingservices.AE_RenderParams_MediaTypeEnum.MediaType_Video);
...
//-------------------------------------------------------------------
public loadOneWebPage( aPlaylistType: string, jsonObject : any, aPlaylistFile: amGeneralFileInfo.am_general.A_FileInfo, iMediaItem: number,
                      aParent: amPlaylistContainer.am_coreservices.AE_PlaylistItem_Container,
                      error: amGeneralError.am_general.A_Error, context: amGeneralContext.am_general.A_Context, callback)
{
  //----------- case amJsonMediaTypeId.am_coreservices.AE_JsonMediaTypeId.WEBPAGE:
  ...
  crtHtmlPageLogic.setDiffusionInfos( 
                      crtHtmlPage._diff_duration,  crtHtmlPage._diff_startDate, crtHtmlPage._diff_endDate,
                      crtHtmlPage._diff_startTime, crtHtmlPage._diff_endTime,   crtHtmlPage._diff_weekdays);
  ...
  prepareParams.getRenderParams().getParamIdentification().setMediaType(
                                  amMediaTypeEnum.am_renderingservices.AE_RenderParams_MediaTypeEnum.MediaType_Html);
...
//-------------------------------------------------------------------
public loadOneHtmlTemplate( aPlaylistType: string, jsonObject : any, aPlaylistFile: amGeneralFileInfo.am_general.A_FileInfo, iMediaItem: number,
                              aParent: amPlaylistContainer.am_coreservices.AE_PlaylistItem_Container,
                              error: amGeneralError.am_general.A_Error, context: amGeneralContext.am_general.A_Context, callback)
{
  return;
  ...
  crtHtmlTemplateLogic.setDiffusionInfos( 
                      crtHtmlTemplate._diff_duration,  crtHtmlTemplate._diff_startDate, crtHtmlTemplate._diff_endDate,
                      crtHtmlTemplate._diff_startTime, crtHtmlTemplate._diff_endTime,   crtHtmlTemplate._diff_weekdays);
...
//-------------------------------------------------------------------
public loadOneDesign( aPlaylistType: string, jsonObject : any, aPlaylistFile: amGeneralFileInfo.am_general.A_FileInfo, iMediaItem: number,
                      aParent: amPlaylistContainer.am_coreservices.AE_PlaylistItem_Container,
                      error: amGeneralError.am_general.A_Error, context: amGeneralContext.am_general.A_Context, callback)
{
  //--------------- case amJsonMediaTypeId.am_coreservices.AE_JsonMediaTypeId.MEDIA_STATIC_MOVIE:
  ...
  crtPlaylistItemDesignLogic.setDiffusionInfos( 
                      crtPlaylistItemDesign._diff_duration,  crtPlaylistItemDesign._diff_startDate, crtPlaylistItemDesign._diff_endDate,
                      crtPlaylistItemDesign._diff_startTime, crtPlaylistItemDesign._diff_endTime,   crtPlaylistItemDesign._diff_weekdays);
...
//-------------------------------------------------------------------
public loadDesignZones( aPlaylistType: string, jsonObject : any, aPlaylistFile: amGeneralFileInfo.am_general.A_FileInfo, 
                        aParent: amPlaylistContainer.am_coreservices.AE_PlaylistItem_Container,
                        error: amGeneralError.am_general.A_Error, context: amGeneralContext.am_general.A_Context, callback)
{
...
//-------------------------------------------------------------------
public loadOneDesignZone( aPlaylistType: string, jsonObject : any, aPlaylistFile: amGeneralFileInfo.am_general.A_FileInfo, iDesignZone: number,
                          aParent: amPlaylistContainer.am_coreservices.AE_PlaylistItem_Container,
                          error: amGeneralError.am_general.A_Error, context: amGeneralContext.am_general.A_Context, callback)
{
  //--------------- case amJsonMediaTypeId.am_coreservices.AE_JsonMediaTypeId.MEDIA_STATIC_MOVIE:
  ...
  crtPlaylistItemDesignZoneLogic.setDiffusionInfos( 
                      crtPlaylistItemDesignZone._diff_duration,  crtPlaylistItemDesignZone._diff_startDate, crtPlaylistItemDesignZone._diff_endDate,
                      crtPlaylistItemDesignZone._diff_startTime, crtPlaylistItemDesignZone._diff_endTime,   crtPlaylistItemDesignZone._diff_weekdays);
  ...
  prepareParams.getRenderParams().getParamContainerPosSize().setAllPosAndSizesInPercentages(
                                                                   percX*0.01, percY*0.01, (percX+percWidth)*0.01, (percY+percHeight)*0.01,
                                                                   -1, -1, -1, -1,
                                                                   parentLeft,//this._owner._iPlaylistControllerConfig.getScreenProperties().getScreenLeft(),
                                                                   ...
                                                                   parentBottom,//this._owner._iPlaylistControllerConfig.getScreenProperties().getScreenBottom(),
                                                                   );
  prepareParams.getRenderParams().getParamContainerAdjustedPosSize().setOrigAllPosAndSizesInPercentages( percX,  percY, percX+percWidth, percY+percHeight,
                                                                                                             0,      0,       percWidth,       percHeight);
  prepareParams.getRenderParams().getParamContainerAdjustedPosSize().setAllPosAndSizesInPercentages(
...
//-------------------------------------------------------------------
public loadOneFillRect( aPlaylistType: string, jsonObject : any, aPlaylistFile: amGeneralFileInfo.am_general.A_FileInfo, iFillRectIdx: number,
                        aParent: amPlaylistContainer.am_coreservices.AE_PlaylistItem_Container,
                        error: amGeneralError.am_general.A_Error, context: amGeneralContext.am_general.A_Context, callback,
                        R: number, G: number, B: number, isVisible: boolean, strDuration: string )
{
    //----- case amJsonMediaTypeId.am_coreservices.AE_JsonMediaTypeId.MEDIA_STATIC:
    ...
    crtPlaylistItemFillRectLogic.setDiffusionInfos( 
                      crtPlaylistItemFillRect._diff_duration,  crtPlaylistItemFillRect._diff_startDate, crtPlaylistItemFillRect._diff_endDate,
                      crtPlaylistItemFillRect._diff_startTime, crtPlaylistItemFillRect._diff_endTime,   crtPlaylistItemFillRect._diff_weekdays);
    ...
    prepareParams.getRenderParams().getParamIdentification().setMediaType(
                                    amMediaTypeEnum.am_renderingservices.AE_RenderParams_MediaTypeEnum.MediaType_Rect);
...
//-------------------------------------------------------------------
public loadOneTag( aPlaylistType: string, jsonObject : any, aPlaylistFile: amGeneralFileInfo.am_general.A_FileInfo, iMediaItem: number,
                   aParent: amPlaylistContainer.am_coreservices.AE_PlaylistItem_Container,
                   error: amGeneralError.am_general.A_Error, context: amGeneralContext.am_general.A_Context, callback)
{
  //-------- case amJsonMediaTypeId.am_coreservices.AE_JsonMediaTypeId.TAG_EXTENDED:
  ...
  crtPlaylistItemTagLogic.setDiffusionInfos( 
                      crtPlaylistItemTag._diff_duration,  crtPlaylistItemTag._diff_startDate, crtPlaylistItemTag._diff_endDate,
                      crtPlaylistItemTag._diff_startTime, crtPlaylistItemTag._diff_endTime,   crtPlaylistItemTag._diff_weekdays);
  ...
  //--------------------
  crtPlaylistItemTagLogic.cmd_setNextChildSelectionType(
    amNextChildSelectionType.am_coreservices.AE_NextChildSelectionType.NextChildSelectionType_ChooseRandom_OnlyOne_ByTagId);
  //--------------------
  var stream:amPlaylistItemStream.am_coreservices.AE_PlaylistItem_Stream = crtPlaylistItemTag.getStream();
  if (stream == null)
    return;
...
//------------------------------------------
public loadStaticMediaItemsInTag( aPlaylistType: string, jsonTagObject : any, jsonStaticMedias: any,
                                  aPlaylistFile: amGeneralFileInfo.am_general.A_FileInfo,
                                  aParent: amPlaylistContainer.am_coreservices.AE_PlaylistItem_Container,
                                  error: amGeneralError.am_general.A_Error, context: amGeneralContext.am_general.A_Context, callback)
{
  //--------------------
...
//--------------------------------------
public getJsonStaticMediaById(staticMediaId : number, jsonStaticMedias: any) : number
{
...
//-------------------------------------------------------------------
public createOrGeAndSetRealTag( nbChildren: number, aPlaylistType: string, jsonObject : any, aPlaylistFile: amGeneralFileInfo.am_general.A_FileInfo, 
                                aParentTag: amPlaylistItemTag.am_coreservices.AE_PlaylistItem_Tag,
                                error: amGeneralError.am_general.A_Error, context: amGeneralContext.am_general.A_Context, callback)
{
  if (nbChildren < 0)
    return;
  var aParentTagLogic = <amPlaylistItemTagLogic.am_coreservices.AE_PlaylistItem_TagLogic>aParentTag.getLogic();
  //--------------------
  var stream:amPlaylistItemStream.am_coreservices.AE_PlaylistItem_Stream = aParentTag.getStream();
  if (stream == null)
    return;
  var tagManager:amPlaylistTagManager.am_coreservices.AE_TagManager = stream.getTagManager();
  if (tagManager == null)
    return;
  var tagId:number = aParentTagLogic.getTagId();
  if (tagId == null)
    return null;
  var existingRealTag:amPlaylistItemRealTag.am_coreservices.AE_PlaylistItem_RealTag= tagManager.getRealTag(tagId);
  if (existingRealTag != null)
  {
    aParentTagLogic.setRealTag(existingRealTag);
    return;
  }
  var newRealTag:amPlaylistItemRealTag.am_coreservices.AE_PlaylistItem_RealTag = this._owner._aServiceLocator._iEntityCreation.createDefaultPlaylistItem_RealTag(error);
  //--
...
//-------------------------------------------------------------------
public loadOneEditableFlash( aPlaylistType: string, jsonObject : any, aPlaylistFile: amGeneralFileInfo.am_general.A_FileInfo, iMediaItem: number,
                             aParent: amPlaylistContainer.am_coreservices.AE_PlaylistItem_Container,
                             error: amGeneralError.am_general.A_Error, context: amGeneralContext.am_general.A_Context, callback)
{
...
//-------------------------------------------------------------------
public loadOneTvTuner( aPlaylistType: string, jsonObject : any, aPlaylistFile: amGeneralFileInfo.am_general.A_FileInfo, iMediaItem: number,
                       aParent: amPlaylistContainer.am_coreservices.AE_PlaylistItem_Container,
                       error: amGeneralError.am_general.A_Error, context: amGeneralContext.am_general.A_Context, callback)
{
...
//-------------------------------------------------------------------
public loadOneTvPassThrough( aPlaylistType: string, jsonObject : any, aPlaylistFile: amGeneralFileInfo.am_general.A_FileInfo, iMediaItem: number,
                             aParent: amPlaylistContainer.am_coreservices.AE_PlaylistItem_Container,
                             error: amGeneralError.am_general.A_Error, context: amGeneralContext.am_general.A_Context, callback)
{
...
//-------------------------------------------------------------------
public loadOneAudioFile( aPlaylistType: string, jsonObject : any, aPlaylistFile: amGeneralFileInfo.am_general.A_FileInfo, iMediaItem: number,
                         aParent: amPlaylistContainer.am_coreservices.AE_PlaylistItem_Container,
                         error: amGeneralError.am_general.A_Error, context: amGeneralContext.am_general.A_Context, callback)
{
  //-------- case amJsonMediaTypeId.am_coreservices.AE_JsonMediaTypeId.AUDIO_FILES:
...
//-------------------------------------------------------------------
public loadOneFlash( aPlaylistType: string, jsonObject : any, aPlaylistFile: amGeneralFileInfo.am_general.A_FileInfo, iMediaItem: number,
                     aParent: amPlaylistContainer.am_coreservices.AE_PlaylistItem_Container,
                     error: amGeneralError.am_general.A_Error, context: amGeneralContext.am_general.A_Context, callback)
{
  //---- case amJsonMediaTypeId.am_coreservices.AE_JsonMediaTypeId.FLASH_OBJECT:
...
//-------------------------------------------------------------------
public loadOnePlaylist2( aPlaylistType: string, jsonObject : any, aPlaylistFile: amGeneralFileInfo.am_general.A_FileInfo, iMediaItem: number,
                         aParent: amPlaylistContainer.am_coreservices.AE_PlaylistItem_Container,
                        error: amGeneralError.am_general.A_Error, context: amGeneralContext.am_general.A_Context, callback)
{
  //---   case amJsonMediaTypeId.am_coreservices.AE_JsonMediaTypeId.PLAYLIST:
...
//-------------------------------------------------------------------
public loadOneVideoOrAudioStream( aPlaylistType: string, jsonObject : any, aPlaylistFile: amGeneralFileInfo.am_general.A_FileInfo, iMediaItem: number,
                                  aParent: amPlaylistContainer.am_coreservices.AE_PlaylistItem_Container,
                                  error: amGeneralError.am_general.A_Error, context: amGeneralContext.am_general.A_Context, callback)
{
  if (jsonObject == null)
...
//-------------------------------------------------------------------
public loadOneVideoStream( aPlaylistType: string, jsonObject : any, aPlaylistFile: amGeneralFileInfo.am_general.A_FileInfo, iMediaItem: number,
                           aParent: amPlaylistContainer.am_coreservices.AE_PlaylistItem_Container,
                          error: amGeneralError.am_general.A_Error, context: amGeneralContext.am_general.A_Context, callback)
{
  ...
  crtPlaylistItemVideoStreamLogic.setDiffusionInfos( 
                      crtPlaylistItemVideoStream._diff_duration,  crtPlaylistItemVideoStream._diff_startDate, crtPlaylistItemVideoStream._diff_endDate,
                      crtPlaylistItemVideoStream._diff_startTime, crtPlaylistItemVideoStream._diff_endTime,   crtPlaylistItemVideoStream._diff_weekdays);
...
//-------------------------------------------------------------------
public loadOneAudioStream( aPlaylistType: string, jsonObject : any, aPlaylistFile: amGeneralFileInfo.am_general.A_FileInfo, iMediaItem: number,
                           aParent: amPlaylistContainer.am_coreservices.AE_PlaylistItem_Container,
                          error: amGeneralError.am_general.A_Error, context: amGeneralContext.am_general.A_Context, callback)
{
  //---- case amJsonMediaTypeId.am_coreservices.AE_JsonMediaTypeId.VIDEO_STREAM:
  ...
  public getEmptyPlaylist() : string
  {
    return IImpl_PlaylistController_Playlist_Mood_v5.EMPTY_PLAYLIST;
     ...
     public static readonly EMPTY_PLAYLIST = "{"+
     "\"ID\": 9999,"+
     "\"Name\": \"Empty PC\","+
     "\"PlayerType\": 1,"+
