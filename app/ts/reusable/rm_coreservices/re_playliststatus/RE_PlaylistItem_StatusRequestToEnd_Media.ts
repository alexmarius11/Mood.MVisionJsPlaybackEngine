import amCoreServices   = require("../../../../../app/ts/abstract/am_coreservices/ae_playliststatus/AE_PlaylistItem_StatusRequestToEnd_Media");
...
{
  export class RE_PlaylistItem_StatusRequestToEnd_Media extends rmPlaylistItemStatus.rm_coreservices.RE_PlaylistItem_StatusRequestToEnd
                                                          implements amCoreServices.am_coreservices.AE_PlaylistItem_StatusRequestToEnd_Media
  {
     //----------------
     constructor()
     {
       super();
       this._statusName = "REQUEST-TO-END_MEDIA";
     }
    ...
    //=============================
    public startMediaEndAndPassedToEndStatus( 
