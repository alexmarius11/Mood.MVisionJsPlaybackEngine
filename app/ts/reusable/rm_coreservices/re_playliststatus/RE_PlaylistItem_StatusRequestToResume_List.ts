import amCoreServices   = require("../../../../../app/ts/abstract/am_coreservices/ae_playliststatus/AE_PlaylistItem_StatusRequestToResume_List");
...
{
  export class RE_PlaylistItem_StatusRequestToResume_List extends rmPlaylistItemStatus.rm_coreservices.RE_PlaylistItem_StatusRequestToResume
                                                          implements amCoreServices.am_coreservices.AE_PlaylistItem_StatusRequestToResume_List
  {
     //----------------
     constructor()
     {
       super();
       this._statusName = "REQUEST-TO-RESUME_LIST";
     }
