import amCoreServices   = require("../../../../../app/ts/abstract/am_coreservices/ae_playliststatus/AE_PlaylistItem_StatusSuspended");
...
{
  export class RE_PlaylistItem_StatusSuspended extends rmPlaylistItemStatus.rm_coreservices.RE_PlaylistItem_Status
                                               implements amCoreServices.am_coreservices.AE_PlaylistItem_StatusSuspended
  {
    //-----------------
    _transitionTo_StatusRequestToResume    : amPlaylistItemTransition.am_coreservices.AE_PlaylistItem_Transition;
    ...
    {
      super();
      this._statusName = "SUSPENDED";
      this._transitionTo_StatusRequestToResume    = null;
