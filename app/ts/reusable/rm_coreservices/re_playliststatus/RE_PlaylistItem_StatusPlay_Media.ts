import amCoreServices   = require("../../../../../app/ts/abstract/am_coreservices/ae_playliststatus/AE_PlaylistItem_StatusPlay_Media");
...
{
  export class RE_PlaylistItem_StatusPlay_Media extends rmPlaylistItemStatus.rm_coreservices.RE_PlaylistItem_StatusPlay
                                                          implements amCoreServices.am_coreservices.AE_PlaylistItem_StatusPlay_Media
  {
     //----------------
     constructor()
     {
       super();
       this._statusName = "PLAY_MEDIA";
     }
