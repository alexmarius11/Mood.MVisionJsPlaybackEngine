import amCoreServices   = require("../../../../../app/ts/abstract/am_coreservices/ae_playliststatus/AE_PlaylistItem_StatusRequestToAbortOrEndBeforePlay_Media");
...
{
  export class RE_PlaylistItem_StatusRequestToAbortOrEndBeforePlay_Media 
                                           extends    rmPlaylistItemStatus.rm_coreservices.RE_PlaylistItem_StatusRequestToAbortOrEndBeforePlay
                                           implements amCoreServices.am_coreservices.AE_PlaylistItem_StatusRequestToAbortOrEndBeforePlay_Media
  {
     //----------------
     constructor()
     {
       super();
       this._statusName = "REQUEST-TO-ABORT-OR-END-BEFORE-PLAY_MEDIA";
     }
