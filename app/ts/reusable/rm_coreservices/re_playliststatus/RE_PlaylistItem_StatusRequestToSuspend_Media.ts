import amCoreServices   = require("../../../../../app/ts/abstract/am_coreservices/ae_playliststatus/AE_PlaylistItem_StatusRequestToSuspend_Media");
...
{
  export class RE_PlaylistItem_StatusRequestToSuspend_Media extends rmPlaylistItemStatus.rm_coreservices.RE_PlaylistItem_StatusRequestToSuspend
                                                            implements amCoreServices.am_coreservices.AE_PlaylistItem_StatusRequestToSuspend_Media
  {
     //----------------
     constructor()
     {
       super();
       this._statusName = "REQUEST-TO-SUSPEND_MEDIA";
     }
    ...
    //=============================
    public startMediaSuspendAndPassedToSuspendedStatus( 
