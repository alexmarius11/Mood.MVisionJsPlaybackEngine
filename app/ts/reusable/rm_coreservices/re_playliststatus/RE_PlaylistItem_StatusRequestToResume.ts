import amCoreServices   = require("../../../../../app/ts/abstract/am_coreservices/ae_playliststatus/AE_PlaylistItem_StatusRequestToResume");
...
{
  export class RE_PlaylistItem_StatusRequestToResume  extends rmPlaylistItemStatus.rm_coreservices.RE_PlaylistItem_Status
                                                      implements amCoreServices.am_coreservices.AE_PlaylistItem_StatusRequestToResume
  {
    //--------------------- 
    _transitionTo_StatusPlay             : amPlaylistItemTransition.am_coreservices.AE_PlaylistItem_Transition;
    ...
    {
      super();
      this._transitionTo_StatusPlay             = null;
