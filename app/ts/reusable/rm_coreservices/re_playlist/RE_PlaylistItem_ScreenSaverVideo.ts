import amCoreServices   = require("../../../../../app/ts/abstract/am_coreservices/ae_playlist/AE_PlaylistItem_ScreenSaverVideo");
...
{
  export class RE_PlaylistItem_ScreenSaverVideo extends rmCoreServicesPlaylistItemVideo.rm_coreservices.RE_PlaylistItem_Video
                                                implements amCoreServices.am_coreservices.AE_PlaylistItem_ScreenSaverVideo  
  {
      //------------------ metadata
      _main_type                  ;
     ...
     {
       super();
       this._playlistItemTypeName = "SCREEN_SAVER_VIDEO"; 
      //------------------ metadata
