import amCoreServices   = require("../../../../../app/ts/abstract/am_coreservices/ae_playlist/AE_PlaylistItem_VideoStream");
...
{
  export class RE_PlaylistItem_VideoStream extends rmCoreServicesPlaylistItem.rm_coreservices.RE_PlaylistItem_MediaItem
                                           implements amCoreServices.am_coreservices.AE_PlaylistItem_VideoStream  
  {
          //------------------ metadata
      _main_type                  ;
     ...
     {
       super();
       this._playlistItemTypeName = "VIDEO_STREAM"; 
        ...
        this._prop_Keep_Aspect_Ratio     = null;
        this._prop_Sound_Volume          = null;
        this._prop_True_Duration         = null;
        this._prop_Width                 = null;
        this._prop_Url                   = null;
        this._prop_StreamType            = null;
