import amCoreServices   = require("../../../../../app/ts/abstract/am_coreservices/ae_playlist/AE_PlaylistItem_Tag");
...
{
  export class RE_PlaylistItem_Tag  extends rmCoreServicesPlaylistItemContainer.rm_coreservices.RE_PlaylistItem_Container
                                    implements amCoreServices.am_coreservices.AE_PlaylistItem_Tag  
  {
      //------------------ properties
      _main_type                  ;
     ...
     {
       super();
       this._playlistItemTypeName = "TAG"; 
