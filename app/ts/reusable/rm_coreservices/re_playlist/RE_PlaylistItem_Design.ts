import amCoreServices   = require("../../../../../app/ts/abstract/am_coreservices/ae_playlist/AE_PlaylistItem_Design");
...
{
  export class RE_PlaylistItem_Design  extends rmCoreServicesPlaylistItemPlaylist.rm_coreservices.RE_PlaylistItem_Playlist
                                       implements amCoreServices.am_coreservices.AE_PlaylistItem_Design  
  {
    //---------------------------
    _main_type                  ;
    ...
    _diff_weekdays              ;
     ...
     {
        super();
        this._playlistItemTypeName = "DESIGN";
        //------------------ metadata
        ...
        this._main_H                     = null;
        this._main_ID_ASPECT_RATIO       = null;
        this._main_W                     = null;
        this._main_X                     = null;
        this._main_Y                     = null;
        this._main_arrZones              = null;
