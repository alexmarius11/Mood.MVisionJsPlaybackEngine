import amCoreServices   = require("../../../../../app/ts/abstract/am_coreservices/ae_playlist/AE_PlaylistItem_TVTunner");
...
{
  export class RE_PlaylistItem_TVTunner extends rmCoreServicesPlaylistItem.rm_coreservices.RE_PlaylistItem_MediaItem
                                        implements amCoreServices.am_coreservices.AE_PlaylistItem_TVTunner 
  {
     //----------------
     constructor()
     {
       super();
       this._playlistItemTypeName = "TV_TUNER"; 
     }
