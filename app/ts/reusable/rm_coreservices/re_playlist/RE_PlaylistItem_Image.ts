import amCoreServices   = require("../../../../../app/ts/abstract/am_coreservices/ae_playlist/AE_PlaylistItem_Image");
...
{
  export class RE_PlaylistItem_Image extends rmCoreServicesPlaylistItem.rm_coreservices.RE_PlaylistItem_MediaItem
                                     implements amCoreServices.am_coreservices.AE_PlaylistItem_Image  
  {
      //------------------ metadata
      _main_type                  ;
     ...
     {
      super();
      this._playlistItemTypeName = "IMAGE"; 
      //------------------ metadata
