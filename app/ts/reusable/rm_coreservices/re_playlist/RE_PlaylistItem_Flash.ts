import amCoreServices   = require("../../../../../app/ts/abstract/am_coreservices/ae_playlist/AE_PlaylistItem_Flash");
...
{
  export class RE_PlaylistItem_Flash  extends rmCoreServicesPlaylistItem.rm_coreservices.RE_PlaylistItem_MediaItem
                                      implements amCoreServices.am_coreservices.AE_PlaylistItem_Flash  
  {
     //----------------
     constructor()
     {
       super();      
       this._playlistItemTypeName = "FLASH"; 
     }
