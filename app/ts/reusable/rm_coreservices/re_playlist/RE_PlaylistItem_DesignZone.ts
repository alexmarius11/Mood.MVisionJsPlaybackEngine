import amCoreServices   = require("../../../../../app/ts/abstract/am_coreservices/ae_playlist/AE_PlaylistItem_DesignZone");
...
import rmPlaylistItemPriorityPlaylist = require("../../../../../app/ts/reusable/rm_coreservices/re_playlist/RE_PlaylistItem_PriorityPlaylist");

export module rm_coreservices
{
  export class RE_PlaylistItem_DesignZone  extends rmPlaylistItemPriorityPlaylist.rm_coreservices.RE_PlaylistItem_PriorityPlaylist
                                           implements amCoreServices.am_coreservices.AE_PlaylistItem_DesignZone  
  {
    ...
    _diff_weekdays   ;
     ...
     {
       super();
       this._playlistItemTypeName = "DESIGN_ZONE";
