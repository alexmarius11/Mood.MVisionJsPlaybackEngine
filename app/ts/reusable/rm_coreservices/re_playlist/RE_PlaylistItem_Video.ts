import amCoreServices   = require("../../../../../app/ts/abstract/am_coreservices/ae_playlist/AE_PlaylistItem_Video");
...
{
  export class RE_PlaylistItem_Video extends rmCoreServicesPlaylistItem.rm_coreservices.RE_PlaylistItem
                                     implements amCoreServices.am_coreservices.AE_PlaylistItem_Video  
  {
      //------------------ metadata
      _main_type                  ;
     ...
     {
       super();
       this._playlistItemTypeName = "VIDEO"; 
