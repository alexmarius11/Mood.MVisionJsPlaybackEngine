import amCoreServices   = require("../../../../../app/ts/abstract/am_coreservices/ae_playlist/AE_PlaylistItem_WebPage");
...
{
  export class RE_PlaylistItem_WebPage extends rmCoreServicesPlaylistItem.rm_coreservices.RE_PlaylistItem_MediaItem
                                       implements amCoreServices.am_coreservices.AE_PlaylistItem_WebPage 
  {
    ...
    _diff_weekdays              ;
     ...
     {
      super();
      this._playlistItemTypeName = "WEB_PAGE"; 
      //------------------ 
