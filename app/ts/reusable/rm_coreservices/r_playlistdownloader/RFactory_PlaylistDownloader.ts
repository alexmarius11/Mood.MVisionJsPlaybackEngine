...
import mod_R_PlaylistDownloader  = require("../../../../../app/ts/reusable/rm_coreservices/r_playlistdownloader/R_PlaylistDownloader");

export module rm_coreservices
{
  export class RFactory_PlaylistDownloader extends rmGeneralServiceFactory.rm_general.RFactory_Service 
