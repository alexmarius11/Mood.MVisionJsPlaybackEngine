...
import mod_R_PlaylistWatcher  = require("../../../../../app/ts/reusable/rm_coreservices/r_playlistwatcher/R_PlaylistWatcher");

export module rm_coreservices
{
  export class RFactory_PlaylistWatcher extends rmGeneralServiceFactory.rm_general.RFactory_Service 
