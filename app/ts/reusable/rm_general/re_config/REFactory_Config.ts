...
import amGeneral3 = require("../../../../../app/ts/abstract/am_general/ae_config/AEFactory_Config");
...
{
  export class REFactory_Config extends    rmGeneralEntityFactory.rm_general.RFactory_Entity
                                implements amGeneral3.am_general.AEFactory_Config
  {
