...
import mod_R_StatisticsService  = require("../../../../../app/ts/reusable/rm_nonrenderingservices/r_statisticsservice/R_StatisticsService");

export module rm_nonrenderingservices
{
  export class RFactory_StatisticsService   extends rmGeneralServiceFactory.rm_general.RFactory_Service 
