...
import mod_R_DiagnosticsService  = require("../../../../../app/ts/reusable/rm_nonrenderingservices/r_diagnosticsservice/R_DiagnosticsService");

export module rm_nonrenderingservices
{
  export class RFactory_DiagnosticsService   extends rmGeneralServiceFactory.rm_general.RFactory_Service 
