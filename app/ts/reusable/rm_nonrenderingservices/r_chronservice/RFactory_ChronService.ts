...
import mod_R_ChronService  = require("../../../../../app/ts/reusable/rm_nonrenderingservices/r_chronservice/R_ChronService");

export module rm_nonrenderingservices
{
  export class RFactory_ChronService   extends rmGeneralServiceFactory.rm_general.RFactory_Service 
