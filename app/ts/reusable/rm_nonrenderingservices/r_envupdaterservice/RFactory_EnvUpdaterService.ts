...
import mod_R_EnvUpdaterService  = require("../../../../../app/ts/reusable/rm_nonrenderingservices/r_envupdaterservice/R_EnvUpdaterService");

export module rm_nonrenderingservices
{
  export class RFactory_EnvUpdaterService   extends rmGeneralServiceFactory.rm_general.RFactory_Service 
