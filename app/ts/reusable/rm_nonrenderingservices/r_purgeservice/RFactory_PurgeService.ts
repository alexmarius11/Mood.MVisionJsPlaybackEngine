...
import mod_R_PurgeService  = require("../../../../../app/ts/reusable/rm_nonrenderingservices/r_purgeservice/R_PurgeService");

export module rm_nonrenderingservices
{
  export class RFactory_PurgeService   extends rmGeneralServiceFactory.rm_general.RFactory_Service 
