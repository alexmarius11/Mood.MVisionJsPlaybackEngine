...
import mod_R_SendLogService  = require("../../../../../app/ts/reusable/rm_nonrenderingservices/r_sendlogservice/R_SendLogService");

export module rm_nonrenderingservices
{
  export class RFactory_SendLogService   extends rmGeneralServiceFactory.rm_general.RFactory_Service 
