...
import mod_R_LiveCommandsService  = require("../../../../../app/ts/reusable/rm_nonrenderingservices/r_livecommandsservice/R_LiveCommandsService");

export module rm_nonrenderingservices
{
  export class RFactory_LiveCommandsService   extends rmGeneralServiceFactory.rm_general.RFactory_Service 
