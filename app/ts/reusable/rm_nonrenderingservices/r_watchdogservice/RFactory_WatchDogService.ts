...
import mod_R_WatchDogService  = require("../../../../../app/ts/reusable/rm_nonrenderingservices/r_watchdogservice/R_WatchDogService");

export module rm_nonrenderingservices
{
  export class RFactory_WatchDogService   extends rmGeneralServiceFactory.rm_general.RFactory_Service 
