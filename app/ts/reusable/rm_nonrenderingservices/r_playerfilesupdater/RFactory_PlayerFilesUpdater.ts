...
import mod_R_PlayerFilesUpdater  = require("../../../../../app/ts/reusable/rm_nonrenderingservices/r_playerfilesupdater/R_PlayerFilesUpdater");

export module rm_nonrenderingservices
{
  export class RFactory_PlayerFilesUpdater   extends rmGeneralServiceFactory.rm_general.RFactory_Service 
