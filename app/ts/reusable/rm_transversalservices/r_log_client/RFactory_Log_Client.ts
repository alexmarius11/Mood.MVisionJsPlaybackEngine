...
import mod_R_Log_Client = require("../../../../../app/ts/reusable/rm_transversalservices/r_log_client/R_Log_Client");

export module rm_transversalservices
{
  export class RFactory_Log_Client   extends rmGeneralServiceFactory.rm_general.RFactory_Service 
