...
import mod_R_Log_Connector = require("../../../../../app/ts/reusable/rm_transversalservices/r_log_connector/R_Log_Connector");

export module rm_transversalservices
{
  export class RFactory_Log_Connector   extends rmGeneralServiceFactory.rm_general.RFactory_Service 
