...
import rmTransversalServicesNotifyJsTV       = require("../../../../../app/ts/reusable/rm_transversalservices/r_sdk_consumer/IImpl_SDK_notifyJsTV_SDKConsumer");
import rmTransversalServicesNotifyFileSystem = require("../../../../../app/ts/reusable/rm_transversalservices/r_sdk_consumer/IImpl_SDK_notifyFileSystem_SDKConsumer");
import rmTransversalServicesNotifyApplicationSetup  = require("../../../../../app/ts/reusable/rm_transversalservices/r_sdk_consumer/IImpl_SDK_notifyApplicationSetup_SDKConsumer");
import rmTransversalServicesNotifyAudioSetup = require("../../../../../app/ts/reusable/rm_transversalservices/r_sdk_consumer/IImpl_SDK_notifyAudioSetup_SDKConsumer");
import rmTransversalServicesNotifyFirmwareSetup = require("../../../../../app/ts/reusable/rm_transversalservices/r_sdk_consumer/IImpl_SDK_notifyFirmwareSetup_SDKConsumer");
import rmTransversalServicesNotifyGeneralConfiguration = require("../../../../../app/ts/reusable/rm_transversalservices/r_sdk_consumer/IImpl_SDK_notifyGeneralConfiguration_SDKConsumer");
import rmTransversalServicesNotifyInputSourceSetup = require("../../../../../app/ts/reusable/rm_transversalservices/r_sdk_consumer/IImpl_SDK_notifyInputSourceSetup_SDKConsumer");
import rmTransversalServicesNotifyPowerSetup = require("../../../../../app/ts/reusable/rm_transversalservices/r_sdk_consumer/IImpl_SDK_notifyPowerSetup_SDKConsumer");
import rmTransversalServicesNotifyTimeSetup = require("../../../../../app/ts/reusable/rm_transversalservices/r_sdk_consumer//IImpl_SDK_notifyTimeSetup_SDKConsumer");
import rmTransversalServicesNotifyTvSignageSetup = require("../../../../../app/ts/reusable/rm_transversalservices/r_sdk_consumer/IImpl_SDK_notifyTvSignageSetup_SDKConsumer");
import rmTransversalServicesNotifyHardwareSetup = require("../../../../../app/ts/reusable/rm_transversalservices/r_sdk_consumer/IImpl_SDK_notifyHardwareSetup_SDKConsumer");


export module rm_transversalservices
{
  export class R_SDK_Consumer extends rmGeneralService.rm_general.R_Service 
                              implements amTransversalServicesSDKConsumer.am_transversalservices.A_SDK_Consumer
  {
    ...
    {      
      ...
      this._iNotify_SDKJsTV       = new rmTransversalServicesNotifyJsTV.rm_transversalservices.IImpl_SDK_notifyJsTV_SDKConsumer(this) ;
      this._iNotify_SDKFileSystem = new rmTransversalServicesNotifyFileSystem.rm_transversalservices.IImpl_SDK_notifyFileSystem_SDKConsumer(this) ;
      this._iNotify_SDKApplicationSetup = new rmTransversalServicesNotifyApplicationSetup.rm_transversalservices.IImpl_SDK_notifyApplicationSetup_SDKConsumer(this) ;
      this._iNotify_SDKAudioSetup = new rmTransversalServicesNotifyAudioSetup.rm_transversalservices.IImpl_SDK_notifyAudioSetup_SDKConsumer(this) ;
      this._iNotify_SDKFirmwareSetup = new rmTransversalServicesNotifyFirmwareSetup.rm_transversalservices.IImpl_SDK_notifyFirmwareSetup_SDKConsumer(this) ;
      this._iNotify_SDKGeneralConfiguration = new rmTransversalServicesNotifyGeneralConfiguration.rm_transversalservices.IImpl_SDK_notifyGeneralConfiguration_SDKConsumer(this) ;
      this._iNotify_SDKInputSourceSetup = new rmTransversalServicesNotifyInputSourceSetup.rm_transversalservices.IImpl_SDK_notifyInputSourceSetup_SDKConsumer(this) ;
      this._iNotify_SDKPowerSetup = new rmTransversalServicesNotifyPowerSetup.rm_transversalservices.IImpl_SDK_notifyPowerSetup_SDKConsumer(this) ;
      this._iNotify_SDKTimeSetup = new rmTransversalServicesNotifyTimeSetup.rm_transversalservices.IImpl_SDK_notifyTimeSetup_SDKConsumer(this) ;
      this._iNotify_SDKTvSignageSetup = new rmTransversalServicesNotifyTvSignageSetup.rm_transversalservices.IImpl_SDK_notifyTvSignageSetup_SDKConsumer(this) ;
      this._iNotify_SDKHardwareSetup = new rmTransversalServicesNotifyHardwareSetup.rm_transversalservices.IImpl_SDK_notifyHardwareSetup_SDKConsumer(this) ;
